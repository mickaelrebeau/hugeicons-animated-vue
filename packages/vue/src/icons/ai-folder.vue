...
// the outer branches answer first, then the middle one, and the folder tips with them
...
const branchLeftVariants: Variants = {
  ...
  animate: {
    transform: ['scale(1)', 'scale(0.28)', 'scale(1.07)', 'scale(1)'],
    opacity: [1, 0.4, 1, 1],
    transition: { duration: 0.52, delay: 0.07, times: [0, 0.3, 0.68, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
...
const branchDownVariants: Variants = {
  ...
  animate: {
    ...
    transition: { duration: 0.52, delay: 0.15, times: [0, 0.3, 0.68, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
