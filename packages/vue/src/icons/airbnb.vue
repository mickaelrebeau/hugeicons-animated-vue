...
// the mark leans in and swells — a host opening the door
...
const markVariants: Variants = {
  ...
  animate: {
    transform: [
      'scale(1) rotate(0deg)',
      'scale(0.93) rotate(-3deg)',
      'scale(1.045) rotate(1deg)',
      'scale(1) rotate(0deg)',
    ],
    transition: { duration: 0.64, times: [0, 0.3, 0.68, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
