...
defineOptions({ inheritAttrs: false, name: 'BodyPartMuscleIcon' })
...
// the biceps flexes from its seated end
// authored from scripts/authored
const bicepsVariants: Variants = {
  normal: { transform: 'translate(0px, 0.00px) scaleY(1)' },
  animate: {
    transform: [
      'translate(0px, 0.00px) scaleY(1)',
      'translate(0px, 1.26px) scaleY(0.88)',
      'translate(0px, -0.84px) scaleY(1.08)',
      'translate(0px, 0.00px) scaleY(1)',
    ],
    transition: {
      duration: 0.66,
