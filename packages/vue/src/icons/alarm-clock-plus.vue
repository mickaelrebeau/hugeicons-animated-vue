...
defineOptions({ inheritAttrs: false, name: 'AlarmClockPlusIcon' })
...
// the bells ring twice over and the cross stamps into the dial between them
...
const bellLeftVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(-10deg)', 'rotate(7deg)', 'rotate(-4deg)', 'rotate(0deg)'],
    transition: { duration: 0.66, times: [0, 0.2, 0.44, 0.7, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
...
const crossVariants: Variants = {
  ...
  animate: {
    ...
    transition: { duration: 0.54, delay: 0.14, times: [0, 0.32, 0.68, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            ...
            <motion.path d="M12.0028 8.99841V15.9984M15.5078 12.4934H8.50781" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="crossVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '12px 12.5px' }" />
          </svg>
        </div>
</template>
