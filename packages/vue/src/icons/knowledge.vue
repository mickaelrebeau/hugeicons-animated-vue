...
defineOptions({ inheritAttrs: false, name: 'KnowledgeIcon' })
...
// after folder-01: the parts of the knowledge move from their own mass and settle together
