...
defineOptions({ inheritAttrs: false, name: 'ThumbsUpEllipseIcon' })
...
// after thumbs-up: the hand rises from the wrist in one coherent approval gesture
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['translateY(0px) rotate(0deg)', 'translateY(-1.7px) rotate(-4.25deg)', 'translateY(0.32px) rotate(1.06deg)', 'translateY(0px) rotate(0deg)'],
    transition: {
      duration: 0.58,
      ease: [0.23, 1, 0.32, 1],
    },
