...
defineOptions({ inheritAttrs: false, name: 'Upload04Icon' })
...
const arrowVariants: Variants = {
  ...
  animate: {
    transform: ['translateY(0px)', 'translateY(-4.61px)', 'translateY(4.61px)', 'translateY(0px)'],
