...
defineOptions({ inheritAttrs: false, name: 'DentalCareIcon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['scale(1) rotate(0deg)', 'scale(0.94) rotate(-2.87deg)', 'scale(1.08) rotate(1.92deg)', 'scale(1) rotate(0deg)'],
    transition: {
      duration: 0.57,
      ease: [0.23, 1, 0.32, 1],
    },
