...
defineOptions({ inheritAttrs: false, name: 'AppleIntelligenceIcon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['scale(1) rotate(0deg)', 'scale(0.94) rotate(-3.16deg)', 'scale(1.08) rotate(2.11deg)', 'scale(1) rotate(0deg)'],
    transition: {
      duration: 0.61,
      ease: [0.23, 1, 0.32, 1],
    },
