...
defineOptions({ inheritAttrs: false, name: 'CallInternalIcon' })
...
// the transfer arc sweeps and the handset follows it
// authored from scripts/authored
const handsetVariants: Variants = {
  normal: { transform: 'rotate(0deg)' },
  animate: {
    transform: ['rotate(0deg)', 'rotate(8deg)', 'rotate(-6deg)', 'rotate(0deg)'],
    transition: { duration: 0.66, delay: 0.08, times: [0, 0.36, 0.68, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
