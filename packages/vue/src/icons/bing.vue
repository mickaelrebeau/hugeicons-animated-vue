...
defineOptions({ inheritAttrs: false, name: 'BingIcon' })
...
// the mark nods from the foot of its stem
...
const markVariants: Variants = {
  ...
  animate: {
    transform: [
      ...
      'translate(0.64px, 0.87px) rotate(6deg)',
      'translate(-0.23px, -0.28px) rotate(-2deg)',
      'translate(0.00px, 0.00px) rotate(0deg)',
    ],
    transition: {
      duration: 0.7,
