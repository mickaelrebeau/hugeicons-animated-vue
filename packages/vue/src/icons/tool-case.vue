...
defineOptions({ inheritAttrs: false, name: 'ToolCaseIcon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(-22.13deg)', 'rotate(8.05deg)', 'rotate(-2.01deg)', 'rotate(0deg)'],
    transition: {
      duration: 0.51,
