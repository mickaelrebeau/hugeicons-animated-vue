...
defineOptions({ inheritAttrs: false, name: 'MessageBlockedIcon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(-8.34deg)', 'rotate(7.3deg)', 'rotate(-4.17deg)', 'rotate(2.09deg)', 'rotate(0deg)'],
    transition: {
      duration: 0.53,
      ease: [0.77, 0, 0.175, 1],
    },
