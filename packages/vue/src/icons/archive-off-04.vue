...
defineOptions({ inheritAttrs: false, name: 'ArchiveOff04Icon' })
...
// the slash cuts the drawer, and both the body and the seam go dim
...
const seamVariants: Variants = {
  ...
  animate: {
    transform: ['scaleX(1)', 'scaleX(1)', 'scaleX(0.7)', 'scaleX(1)'],
    opacity: [1, 1, 0.3, 1],
    transition: {
      duration: 0.82,
      delay: 0.08,
