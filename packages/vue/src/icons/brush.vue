...
// the brush takes a stroke, rocking on its bristle tip
...
const brushVariants: Variants = {
  ...
  animate: {
    transform: [
      ...
      'translate(-1.06px, -1.14px) rotate(-8deg)',
      'translate(0.68px, 0.95px) rotate(6deg)',
      'translate(-0.25px, -0.30px) rotate(-2deg)',
      'translate(0.00px, 0.00px) rotate(0deg)',
    ],
    transition: {
      duration: 0.72,
