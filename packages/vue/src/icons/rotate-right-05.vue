...
defineOptions({ inheritAttrs: false, name: 'RotateRight05Icon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(-24.37deg)', 'rotate(360deg)'],
    transition: {
      duration: 0.87,
      times: [0, 0.2, 1],
      ease: ['easeIn', 'easeOut'],
