...
defineOptions({ inheritAttrs: false, name: 'Certificate01Icon' })
...
// after folder-01: the parts of the certificate move from their own mass and settle together
