...
defineOptions({ inheritAttrs: false, name: 'MusicNoteSquare02Icon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(-7.94deg)', 'rotate(2.98deg)', 'rotate(0deg)'],
    transition: {
      duration: 0.55,
      ease: [0.23, 1, 0.32, 1],
    },
