...
defineOptions({ inheritAttrs: false, name: 'Asteroid01Icon' })
...
// the small meteor dives into the rock, the body and craters flinch together, then it springs off
...
const meteorVariants: Variants = {
  ...
  animate: {
    transform: [
      ...
      'translate(-0.41px, 0.51px) rotate(-10deg)',
      'translate(-2.28px, 2.82px) rotate(14deg)',
      'translate(0.36px, -0.45px) rotate(-5deg)',
      'translate(0px, 0px) rotate(0deg)',
    ],
    transition: {
      duration: 0.74,
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            ...
            <motion.path d="M11 15.5L9.5 17" stroke="currentColor" stroke-linecap="round" stroke-width="1.5" :variants="rockVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '10.3px 16.3px' }" />
            <motion.path d="M9 10.753C8.05719 10.1652 7.58579 9.87123 7.14645 10.0538C6.70711 10.2365 6.4714 10.8243 6 12" stroke="currentColor" stroke-linecap="round" stroke-width="1.5" :variants="rockVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '7.5px 10.9px' }" />
