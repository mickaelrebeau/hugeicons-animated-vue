...
defineOptions({ inheritAttrs: false, name: 'ReIcon' })
...
// after dashboard-square-01: the separate cells of the re assemble from top-left to bottom-right
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            ...
            <motion.path d="M6.5 14C6.5 14 8 12 9.5 13.5M6.5 14V17.5M6.5 14V12.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="tileVariants" :custom="0" :animate="controls" initial="normal" :style="{ transformOrigin: '8px 14.75px' }" />
            <motion.path d="M11.5 15V14.25C11.5 13.2835 12.2835 12.5 13.25 12.5C14.2165 12.5 15 13.2835 15 14.25V15H11.5ZM11.5 15V15.75C11.5 16.7165 12.2835 17.5 13.25 17.5C13.7397 17.5 14.1824 17.2989 14.5 16.9747" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="tileVariants" :custom="1" :animate="controls" initial="normal" :style="{ transformOrigin: '13.25px 15px' }" />
