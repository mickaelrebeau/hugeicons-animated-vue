...
// the tick lands first, then the rings and the date line catch up
// authored from scripts/authored
const ringsVariants: Variants = {
  normal: { transform: 'translateY(0px)' },
  animate: {
    transform: ['translateY(0px)', 'translateY(-1.2px)', 'translateY(0.25px)', 'translateY(0px)'],
    transition: { duration: 0.5, delay: 0.16, times: [0, 0.32, 0.66, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
