...
defineOptions({ inheritAttrs: false, name: 'CallPaused02Icon' })
...
// the pause bars pinch shut and the handset holds its breath
...
const pauseVariants: Variants = {
  ...
  animate: {
    transform: [
      ...
      'translate(0.00px, 0px) scaleX(0.35)',
      'translate(0.00px, 0px) scaleX(0.35)',
      'translate(0.00px, 0px) scaleX(1)',
    ],
    transition: {
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            <motion.path d="M19 3V9M15 3V9" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="pauseVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '17px 6px' }" />
