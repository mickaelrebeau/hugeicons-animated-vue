...
defineOptions({ inheritAttrs: false, name: 'MoonCloudSlowWindIcon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg) translateX(0px)', 'rotate(-11.38deg) translateX(1.52px)', 'rotate(4.74deg) translateX(-0.38px)', 'rotate(-1.9deg) translateX(0.19px)', 'rotate(0deg) translateX(0px)'],
    transition: {
      duration: 0.66,
      ease: [0.23, 1, 0.32, 1],
    },
