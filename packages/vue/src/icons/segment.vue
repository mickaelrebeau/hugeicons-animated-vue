...
defineOptions({ inheritAttrs: false, name: 'SegmentIcon' })
...
// after folder-01: the parts of the segment move from their own mass and settle together
