...
defineOptions({ inheritAttrs: false, name: 'WhatsappIcon' })
...
// after folder-01: the parts of the whatsapp move from their own mass and settle together
