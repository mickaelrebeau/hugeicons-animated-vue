...
defineOptions({ inheritAttrs: false, name: 'Home08Icon' })
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            ...
            <motion.path d="M17 15.5H15V17.5H17V15.5Z" stroke="currentColor" stroke-linejoin="round" stroke-width="2" :variants="markVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '15px 16.5px' }" />
          </svg>
        </div>
</template>
