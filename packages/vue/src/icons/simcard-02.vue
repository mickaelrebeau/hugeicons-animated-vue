...
defineOptions({ inheritAttrs: false, name: 'Simcard02Icon' })
...
// after credit-card: the chip slides toward its slot and clicks into registration
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['translateX(0px) rotate(0deg)', 'translateX(2.51px) rotate(2.1deg)', 'translateX(-0.31px) rotate(-0.52deg)', 'translateX(0px) rotate(0deg)'],
    transition: {
      duration: 0.57,
      ease: [0.23, 1, 0.32, 1],
    },
