...
defineOptions({ inheritAttrs: false, name: 'Brain02Icon' })
...
const dotVariants: Variants = {
  ...
  animate: (i: number) => ({
    transform: ['translateY(0px) scale(1)', 'translateY(-1.63px) scale(1.2)', 'translateY(0.38px) scale(0.95)', 'translateY(0px) scale(1)'],
