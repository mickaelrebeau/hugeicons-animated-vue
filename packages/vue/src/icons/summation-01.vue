...
defineOptions({ inheritAttrs: false, name: 'Summation01Icon' })
...
const nibVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg) translate(0px, 0px)', 'rotate(-7.79deg) translate(-0.39px, 0.58px)', 'rotate(3.89deg) translate(0.29px, -0.29px)', 'rotate(0deg) translate(0px, 0px)'],
    transition: {
      duration: 0.54,
      ease: [0.23, 1, 0.32, 1],
    },
