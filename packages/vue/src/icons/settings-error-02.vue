...
defineOptions({ inheritAttrs: false, name: 'SettingsError02Icon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(-7.96deg)', 'rotate(6.97deg)', 'rotate(-3.98deg)', 'rotate(1.99deg)', 'rotate(0deg)'],
    transition: {
      duration: 0.51,
      ease: [0.77, 0, 0.175, 1],
    },
