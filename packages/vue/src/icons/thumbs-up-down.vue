...
defineOptions({ inheritAttrs: false, name: 'ThumbsUpDownIcon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['translateY(0px) rotate(0deg)', 'translateY(-1.57px) rotate(-3.93deg)', 'translateY(0.29px) rotate(0.98deg)', 'translateY(0px) rotate(0deg)'],
    transition: {
      duration: 0.54,
      ease: [0.23, 1, 0.32, 1],
    },
