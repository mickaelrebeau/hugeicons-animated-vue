...
defineOptions({ inheritAttrs: false, name: 'SquareArrowVerticalIcon' })
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            <motion.path d="M12 18L12 6M12 18C12.7002 18 14.0085 16.0057 14.5 15.5M12 18C11.2998 18 9.99153 16.0057 9.5 15.5M12 6C12.7002 6 14.0085 7.9943 14.5 8.5M12 6C11.2998 6 9.99153 7.9943 9.5 8.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="arrowVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '12px 12px' }" />
