...
defineOptions({ inheritAttrs: false, name: 'NewTwitterIcon' })
...
const plusVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg) scale(1)', 'rotate(-9.39deg) scale(0.82)', 'rotate(2.82deg) scale(1.08)', 'rotate(0deg) scale(1)'],
    transition: {
      duration: 0.4,
      delay: 0.04,
      ease: [0.23, 1, 0.32, 1],
