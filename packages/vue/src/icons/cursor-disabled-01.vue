...
defineOptions({ inheritAttrs: false, name: 'CursorDisabled01Icon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg) translateY(0px)', 'rotate(-7.59deg) translateY(0.38px)', 'rotate(0deg) translateY(1.14px)', 'rotate(0deg) translateY(0px)'],
    opacity: [1, 1, 0.55, 1],
    transition: {
      duration: 0.66,
      ease: [0.77, 0, 0.175, 1],
