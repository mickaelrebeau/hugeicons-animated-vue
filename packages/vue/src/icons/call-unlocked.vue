...
defineOptions({ inheritAttrs: false, name: 'CallUnlockedIcon' })
...
// the shackle swings clear and the handset lifts
...
const shackleVariants: Variants = {
  ...
  animate: {
    transform: [
      ...
      'translate(-0.64px, 1.16px) rotate(-32deg)',
      'translate(-0.27px, 0.32px) rotate(-10deg)',
      'translate(0.00px, 0.00px) rotate(0deg)',
    ],
    transition: {
      duration: 0.66,
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            ...
            <motion.path d="M14.5 6.5V5C14.5 3.89543 15.3954 3 16.5 3C17.0523 3 17.5523 3.22386 17.9142 3.58579" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="shackleVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '16.2px 4.8px' }" />
            <path d="M18.5 6.5H14.5C13.6716 6.5 13 7.17157 13 8V9.5C13 10.3284 13.6716 11 14.5 11H18.5C19.3284 11 20 10.3284 20 9.5V8C20 7.17157 19.3284 6.5 18.5 6.5Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" />
          </svg>
        </div>
</template>
