...
defineOptions({ inheritAttrs: false, name: 'CircleOffIcon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg) translateY(0px)', 'rotate(-8.42deg) translateY(0.42px)', 'rotate(0deg) translateY(1.26px)', 'rotate(0deg) translateY(0px)'],
    opacity: [1, 1, 0.55, 1],
    transition: {
      duration: 0.72,
      ease: [0.77, 0, 0.175, 1],
