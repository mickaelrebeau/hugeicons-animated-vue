...
defineOptions({ inheritAttrs: false, name: 'GreekHelmetIcon' })
...
// after folder-01: the parts of the greek helmet move from their own mass and settle together
