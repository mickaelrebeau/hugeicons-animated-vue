...
defineOptions({ inheritAttrs: false, name: 'RotateLeft06Icon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(-23.38deg)', 'rotate(360deg)'],
    transition: {
      duration: 0.96,
      times: [0, 0.2, 1],
      ease: ['easeIn', 'easeOut'],
