...
defineOptions({ inheritAttrs: false, name: 'StoreManagementIcon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['translateY(0px)', 'translateY(-2.17px)', 'translateY(0px)'],
    transition: {
      duration: 0.52,
      ease: 'easeInOut',
      times: [0, 0.35, 1],
