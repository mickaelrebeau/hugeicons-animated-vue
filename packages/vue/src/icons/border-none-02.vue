...
defineOptions({ inheritAttrs: false, name: 'BorderNone02Icon' })
...
// the corner dashes rewrite
// authored from scripts/authored
const dashesVariants: Variants = {
