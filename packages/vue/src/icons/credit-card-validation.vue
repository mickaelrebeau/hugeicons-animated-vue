...
defineOptions({ inheritAttrs: false, name: 'CreditCardValidationIcon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['translateX(0px) rotate(0deg)', 'translateX(2.55px) rotate(2.13deg)', 'translateX(-0.32px) rotate(-0.53deg)', 'translateX(0px) rotate(0deg)'],
    transition: {
      duration: 0.58,
      ease: [0.23, 1, 0.32, 1],
    },
