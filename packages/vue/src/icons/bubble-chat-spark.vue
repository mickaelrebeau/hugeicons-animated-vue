...
defineOptions({ inheritAttrs: false, name: 'BubbleChatSparkIcon' })
...
// the spark inside the bubble turns onto its points, then the bubble answers
...
const starVariants: Variants = {
  ...
  animate: {
    ...
    transition: { duration: 0.7, times: [0, 0.36, 0.76, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
