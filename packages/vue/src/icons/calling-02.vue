...
defineOptions({ inheritAttrs: false, name: 'Calling02Icon' })
...
// the handset stays at the ear while the waves keep leaving it
...
const wavesVariants: Variants = {
  ...
  animate: {
    ...
    transition: { duration: 0.76, times: [0, 0.22, 0.44, 0.68, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            <motion.path d="M13 3C17.4183 3 21 6.58172 21 11M13.5 6.5C15.7091 6.5 17.5 8.29086 17.5 10.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="wavesVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '13px 11px' }" />
