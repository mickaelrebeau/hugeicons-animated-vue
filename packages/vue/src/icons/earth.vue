...
defineOptions({ inheritAttrs: false, name: 'EarthIcon' })
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            ...
            <motion.g :variants="globeVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '12px 12px' }">
              <path :d="EARTH_RIM" stroke="currentColor" stroke-linejoin="round" stroke-width="1.5" />
              <g :clip-path="`url(#${clipId})`">
                <motion.path :d="EARTH_WORLD_START" stroke="currentColor" stroke-linejoin="round" stroke-width="1.5" :variants="worldVariants" :animate="controls" initial="normal" />
              </g>
            </motion.g>
          </svg>
        </div>
