...
defineOptions({ inheritAttrs: false, name: 'SmartPhoneIcon' })
...
const dotVariants: Variants = {
  ...
  animate: (i: number) => ({
    transform: ['translateY(0px) scale(1)', 'translateY(-1.61px) scale(1.2)', 'translateY(0.37px) scale(0.95)', 'translateY(0px) scale(1)'],
