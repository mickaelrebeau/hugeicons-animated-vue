...
defineOptions({ inheritAttrs: false, name: 'CastboxIcon' })
...
// after folder-01: the parts of the castbox move from their own mass and settle together
