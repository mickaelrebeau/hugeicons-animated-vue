...
defineOptions({ inheritAttrs: false, name: 'MaterialAndTextureIcon' })
...
// after wifi-01: the arcs of the material and texture propagate outward from their geometric source
