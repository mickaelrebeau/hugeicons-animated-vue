...
defineOptions({ inheritAttrs: false, name: 'ThreeDScaleIcon' })
...
// after copy-01: the nested parts of the three d scale separate in depth and stack again
