...
const planeVariants: Variants = {
  ...
  animate: {
    transform: ['translate(-20.94px, -14.66px) rotate(10.47deg)', 'translate(-20.94px, -14.66px) rotate(10.47deg)', 'translate(-10.47px, -7.33px) rotate(6.28deg)', 'translate(-3.14px, -1.57px) rotate(2.09deg)', 'translate(0.63px, 1.15px) rotate(-0.42deg)', 'translate(0px, 0px) rotate(0deg)'],
    visibility: 'visible',
    transition: {
      duration: 1.17,
