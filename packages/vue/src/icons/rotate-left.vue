...
defineOptions({ inheritAttrs: false, name: 'RotateLeftIcon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(-27.13deg)', 'rotate(360deg)'],
    transition: {
      duration: 0.94,
      times: [0, 0.2, 1],
      ease: ['easeIn', 'easeOut'],
