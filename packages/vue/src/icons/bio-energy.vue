...
// both leaves sway from the stem tip, stalk and ground holding
// authored from scripts/authored
const leafLVariants: Variants = {
  normal: { transform: 'translate(0.00px, 0.00px) rotate(0deg)' },
  animate: {
    transform: [
      'translate(0.00px, 0.00px) rotate(0deg)',
      'translate(-0.13px, 0.54px) rotate(-10deg)',
      'translate(0.17px, -0.41px) rotate(8deg)',
      'translate(-0.05px, 0.16px) rotate(-3deg)',
      'translate(0.00px, 0.00px) rotate(0deg)',
    ],
    transition: {
      duration: 0.76,
...
const leafRVariants: Variants = {
  normal: { transform: 'translate(0.00px, 0.00px) rotate(0deg)' },
  animate: {
    transform: [
      'translate(0.00px, 0.00px) rotate(0deg)',
      'translate(-0.30px, 0.41px) rotate(10deg)',
      'translate(0.18px, -0.36px) rotate(-8deg)',
      'translate(-0.08px, 0.13px) rotate(3deg)',
      'translate(0.00px, 0.00px) rotate(0deg)',
    ],
    transition: {
      duration: 0.76,
