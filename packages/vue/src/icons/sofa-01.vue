...
defineOptions({ inheritAttrs: false, name: 'Sofa01Icon' })
...
const seatVariants: Variants = {
  ...
  animate: {
    transform: ['translateY(0px) scaleY(1)', 'translateY(-0.57px) scaleY(1.04)', 'translateY(1.32px) scaleY(0.86)', 'translateY(-0.14px) scaleY(1.02)', 'translateY(0px) scaleY(1)'],
    transition: {
      duration: 0.59,
