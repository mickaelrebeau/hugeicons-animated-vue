...
defineOptions({ inheritAttrs: false, name: 'BookBookmark02Icon' })
...
// the flush-top ribbon strokes stretch from the still head into the cover, curl holding
// authored from scripts/authored
const ribbonVariants: Variants = {
  normal: { d: 'M9 2V10L12 7L15 10V2' },
  animate: {
    d: [
      'M9 2V10L12 7L15 10V2',
      'M9 2V11.6L12 8.6L15 11.6V2',
      'M9 2V11.6L12 8.6L15 11.6V2',
      'M9 2V10L12 7L15 10V2',
    ],
    transition: {
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            ...
            <motion.path d="M9 2V10L12 7L15 10V2" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="ribbonVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '12px 6px' }" />
          </svg>
        </div>
</template>
