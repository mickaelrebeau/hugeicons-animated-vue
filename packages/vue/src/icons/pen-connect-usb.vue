...
defineOptions({ inheritAttrs: false, name: 'PenConnectUsbIcon' })
...
const nibVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg) translate(0px, 0px)', 'rotate(-8.33deg) translate(-0.42px, 0.63px)', 'rotate(4.17deg) translate(0.31px, -0.31px)', 'rotate(0deg) translate(0px, 0px)'],
    transition: {
      duration: 0.57,
      ease: [0.23, 1, 0.32, 1],
    },
