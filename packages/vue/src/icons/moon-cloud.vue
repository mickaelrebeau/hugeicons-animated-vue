...
defineOptions({ inheritAttrs: false, name: 'MoonCloudIcon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['translateY(0px)', 'translateY(-1.3px)', 'translateY(0.32px)', 'translateY(0px)'],
    transition: {
      duration: 0.73,
      ease: [0.77, 0, 0.175, 1],
    },
