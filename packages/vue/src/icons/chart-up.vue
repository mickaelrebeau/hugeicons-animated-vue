...
defineOptions({ inheritAttrs: false, name: 'ChartUpIcon' })
...
const barVariants: Variants = {
  ...
  animate: (i: number) => ({
    transform: ['translateY(2.27px) scaleY(0.6)', 'translateY(-0.52px) scaleY(1.08)', 'translateY(0px) scaleY(1)'],
