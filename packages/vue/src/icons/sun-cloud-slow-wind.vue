...
defineOptions({ inheritAttrs: false, name: 'SunCloudSlowWindIcon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg) translateX(0px)', 'rotate(-11.99deg) translateX(1.6px)', 'rotate(4.99deg) translateX(-0.4px)', 'rotate(-2deg) translateX(0.2px)', 'rotate(0deg) translateX(0px)'],
    transition: {
      duration: 0.69,
      ease: [0.23, 1, 0.32, 1],
    },
