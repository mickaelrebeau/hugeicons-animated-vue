...
defineOptions({ inheritAttrs: false, name: 'ShapesIcon' })
...
// after home-01: the silhouette of the shapes loads onto its base and settles with weight
