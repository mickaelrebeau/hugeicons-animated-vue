...
defineOptions({ inheritAttrs: false, name: 'WaterPumpIcon' })
...
// after dashboard-square-01: the separate cells of the water pump assemble from top-left to bottom-right
...
const tileVariants: Variants = {
  ...
  animate: (i: number) => ({
    transform: ['translateY(1.46px) scale(0.74)', 'translateY(-0.42px) scale(1.1)', 'translateY(0px) scale(1)'],
