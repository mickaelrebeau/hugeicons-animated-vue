...
defineOptions({ inheritAttrs: false, name: 'AmpouleIcon' })
...
// the left vial tips to pour, then the right one — two doses, one after the other
// authored from scripts/authored
const vialLeftVariants: Variants = {
  normal: { transform: 'rotate(0deg)' },
  animate: {
    transform: ['rotate(0deg)', 'rotate(-7deg)', 'rotate(1.6deg)', 'rotate(0deg)'],
    transition: { duration: 0.62, times: [0, 0.36, 0.7, 1], ease: [0.23, 1, 0.32, 1] },
  },
};

const levelLeftVariants: Variants = {
  normal: { transform: 'scaleX(1) translateY(0px)' },
  animate: {
    transform: ['scaleX(1) translateY(0px)', 'scaleX(0.7) translateY(0.6px)', 'scaleX(1) translateY(0px)'],
    transition: { duration: 0.62, delay: 0.06, times: [0, 0.4, 1], ease: [0.23, 1, 0.32, 1] },
  },
};

const vialRightVariants: Variants = {
  normal: { transform: 'rotate(0deg)' },
  animate: {
    transform: ['rotate(0deg)', 'rotate(7deg)', 'rotate(-1.6deg)', 'rotate(0deg)'],
    transition: { duration: 0.62, delay: 0.16, times: [0, 0.36, 0.7, 1], ease: [0.23, 1, 0.32, 1] },
  },
};

const levelRightVariants: Variants = {
  normal: { transform: 'scaleX(1) translateY(0px)' },
  animate: {
    transform: ['scaleX(1) translateY(0px)', 'scaleX(0.7) translateY(0.6px)', 'scaleX(1) translateY(0px)'],
    transition: { duration: 0.62, delay: 0.22, times: [0, 0.4, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
