...
defineOptions({ inheritAttrs: false, name: 'BubbleChatIcon' })
...
// the three dots type on, the bubble holding still
// authored from scripts/authored
const dotsVariants: Variants = {
  normal: { opacity: 1 },
  animate: {
    opacity: [1, 0.15, 1, 0.35, 1],
    transition: { duration: 0.7, times: [0, 0.18, 0.4, 0.62, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
