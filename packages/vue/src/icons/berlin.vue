...
defineOptions({ inheritAttrs: false, name: 'BerlinIcon' })
...
// after edit-02: the open stroke of the berlin writes along the direction of its path
...
const nibVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg) translate(0px, 0px)', 'rotate(-8.12deg) translate(-0.41px, 0.61px)', 'rotate(4.06deg) translate(0.3px, -0.3px)', 'rotate(0deg) translate(0px, 0px)'],
    transition: {
      duration: 0.56,
      ease: [0.23, 1, 0.32, 1],
    },
