...
defineOptions({ inheritAttrs: false, name: 'Bone01Icon' })
...
// the bone tosses from one knobby end
...
const boneVariants: Variants = {
  ...
  animate: {
    transform: [
      ...
      'translate(1.70px, 2.17px) rotate(14deg)',
      'translate(-1.19px, -1.04px) rotate(-8deg)',
      'translate(0.41px, 0.43px) rotate(3deg)',
      'translate(0.00px, 0.00px) rotate(0deg)',
    ],
    transition: {
      duration: 0.72,
