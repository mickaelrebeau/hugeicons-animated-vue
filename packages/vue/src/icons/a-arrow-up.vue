...
defineOptions({ inheritAttrs: false, name: 'AArrowUpIcon' })
...
// the letter holds the baseline while the arrow lifts, head first, and settles
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            ...
            <motion.path d="M18 8V17" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="shaftVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '18px 17px' }" />
            ...
            <motion.path d="M14 11C14 11 16.946 7.00001 18 7C19.0541 6.99999 22 11 22 11" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="headVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '18px 9px' }" />
          </svg>
        </div>
</template>
