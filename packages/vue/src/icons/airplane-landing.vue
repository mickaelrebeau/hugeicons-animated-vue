...
// a long approach, a float in the flare, then a firm touchdown that ripples the strip twice
// authored from scripts/authored
const runwayVariants: Variants = {
  normal: { transform: 'scaleX(1)' },
  animate: {
    transform: ['scaleX(1)', 'scaleX(1)', 'scaleX(0.92)', 'scaleX(1.03)', 'scaleX(0.97)', 'scaleX(1)'],
    transition: { duration: 1.24, times: [0, 0.7, 0.8, 0.87, 0.94, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
...
const airlinerVariants: Variants = {
  ...
  animate: {
    transform: [
      ...
      'translate(-10%, -16%) rotate(5.5deg)',
      'translate(-10%, -16%) rotate(5.5deg)',
      'translate(-3%, -5%) rotate(2deg)',
      'translate(-1.6%, -1.4%) rotate(0.6deg)',
      'translate(0%, 0%) rotate(0deg)',
    ],
    transition: {
      duration: 1.24,
      times: [0, 0.26, 0.34, 0.6, 0.8, 1],
      ease: [
        [0.23, 1, 0.32, 1],
        'linear',
        [0.77, 0, 0.175, 1],
