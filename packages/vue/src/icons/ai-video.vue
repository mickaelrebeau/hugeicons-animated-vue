...
// the play head pushes forward into the clip and eases back
...
const playHeadVariants: Variants = {
  ...
  animate: {
    transform: [
      ...
      'translateX(1.3px) scale(1.06)',
      'translateX(-0.2px) scale(0.99)',
      'translateX(0px) scale(1)',
    ],
    transition: { duration: 0.62, times: [0, 0.36, 0.72, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
...
const sparkVariants: Variants = {
  ...
  animate: {
    ...
    opacity: [1, 0.5, 1, 1],
    transition: { duration: 0.62, delay: 0.32, times: [0, 0.3, 0.66, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
