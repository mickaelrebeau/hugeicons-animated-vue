...
// the copy is written out fast and the spark spins as it finishes
...
const sparkVariants: Variants = {
  ...
  animate: {
    transform: [
      ...
      'rotate(0deg) scale(1.16)',
      'rotate(0deg) scale(1)',
    ],
    opacity: [1, 0.5, 1, 1],
    transition: { duration: 0.66, delay: 0.5, times: [0, 0.34, 0.7, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
