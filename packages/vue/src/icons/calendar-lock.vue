...
defineOptions({ inheritAttrs: false, name: 'CalendarLockIcon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['rotateX(0deg) scaleY(1)', 'rotateX(-55deg) scaleY(0.72)', 'rotateX(8.44deg) scaleY(1.04)', 'rotateX(0deg) scaleY(1)'],
    transition: {
      duration: 0.66,
      ease: [0.23, 1, 0.32, 1],
    },
