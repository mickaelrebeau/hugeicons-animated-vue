...
defineOptions({ inheritAttrs: false, name: 'Rar02Icon' })
...
// after folder-01: the parts of the rar move from their own mass and settle together
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            ...
            <motion.path d="M7 16.5V14H8.75C9.44036 14 10 14.5596 10 15.25C10 15.9404 9.44036 16.5 8.75 16.5M7 16.5V19M7 16.5H8.75M8.75 16.5L10 19M18 16.5V14H19.75C20.4404 14 21 14.5596 21 15.25C21 15.9404 20.4404 16.5 19.75 16.5M18 16.5V19M18 16.5H19.75M19.75 16.5L21 19M12 19L13.75 14H14.25L16 19M13 17.5H15" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="folderVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '11px 22px' }" />
          </svg>
        </div>
</template>
