...
defineOptions({ inheritAttrs: false, name: 'UserStar01Icon' })
...
const headVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(14.78deg)', 'rotate(-3.69deg)', 'rotate(0deg)'],
    transition: {
      duration: 0.64,
      ease: 'easeInOut',
      times: [0, 0.4, 0.7, 1],
...
const personVariants: Variants = {
  ...
  animate: {
    transform: ['translateY(0px) scale(1)', 'translateY(-1.52px) scale(1.03)', 'translateY(0.51px) scale(0.98)', 'translateY(0px) scale(1)'],
    transition: {
      duration: 0.56,
      ease: [0.23, 1, 0.32, 1],
    },
