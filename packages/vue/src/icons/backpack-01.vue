...
// the flap closes over the bag, the zip draws, then both straps seat
...
const strapLVariants: Variants = {
  ...
  animate: {
    transform: [
      'translate(0px, 0px)',
      'translate(-1.5px, 0px)',
      'translate(0.21000000000000002px, 0px)',
      'translate(0px, 0px)',
    ],
    transition: {
      duration: 0.54,
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            ...
            <motion.path d="M5 17C6.64996 15.17 9.17273 14 12 14C14.8273 14 17.35 15.17 19 17" stroke="currentColor" stroke-linejoin="round" stroke-width="1.5" :variants="flapVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '12px 14px' }" />
            <motion.path d="M11 10H13" stroke="currentColor" stroke-linecap="round" stroke-width="1.5" :variants="zipVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '12px 10px' }" />
