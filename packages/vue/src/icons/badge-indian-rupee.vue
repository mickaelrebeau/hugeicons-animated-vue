...
// the rupee bars rewrite on the still badge
// authored from scripts/authored
const rupeeVariants: Variants = {
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            ...
            <motion.path d="M10 8C11.933 8 13.5 9.567 13.5 11.5C13.5 13.433 11.933 15 10 15H9L14 16M9 11.5H16M9 8H16" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="rupeeVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '12.5px 12px' }" />
          </svg>
        </div>
</template>
