...
defineOptions({ inheritAttrs: false, name: 'TranslationIcon' })
...
// after folder-01: the parts of the translation move from their own mass and settle together
