...
defineOptions({ inheritAttrs: false, name: 'ConnectIcon' })
...
// after folder-01: the parts of the connect move from their own mass and settle together
