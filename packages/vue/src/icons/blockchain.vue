...
defineOptions({ inheritAttrs: false, name: 'BlockchainIcon' })
...
// both prisms tip from the base as one stack
...
const lowerVariants: Variants = {
  ...
  animate: {
    transform: [
      ...
      'translate(0.58px, 0.03px) rotate(5deg)',
      'translate(-0.47px, 0.02px) rotate(-4deg)',
      'translate(0.18px, 0.00px) rotate(1.5deg)',
      'translate(0.00px, 0.00px) rotate(0deg)',
    ],
    transition: {
      duration: 0.7,
...
const upperVariants: Variants = {
  ...
  animate: {
    transform: [
      'translate(0.00px, 0.00px) rotate(0deg)',
      'translate(1.18px, 0.05px) rotate(5deg)',
      'translate(-0.94px, 0.03px) rotate(-4deg)',
      'translate(0.35px, 0.00px) rotate(1.5deg)',
      'translate(0.00px, 0.00px) rotate(0deg)',
    ],
    transition: {
      duration: 0.7,
