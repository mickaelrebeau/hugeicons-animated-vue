...
defineOptions({ inheritAttrs: false, name: 'BitcoinSafeIcon' })
...
// the hinge pulls open, feet planted, body and B holding
// authored from scripts/authored
const hingeVariants: Variants = {
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            ...
            <motion.path d="M7 15C6 14.4692 6 13.6148 6 11.9062V10.0938C6 8.38516 6 7.53082 7 7" stroke="currentColor" stroke-linecap="round" stroke-width="1.5" :variants="hingeVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '6.5px 11px' }" />
            <path d="M18 22V20" stroke="currentColor" stroke-linecap="round" stroke-width="1.5" />
            <path d="M6 22V20" stroke="currentColor" stroke-linecap="round" stroke-width="1.5" />
