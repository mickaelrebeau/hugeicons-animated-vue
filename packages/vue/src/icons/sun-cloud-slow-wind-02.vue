...
defineOptions({ inheritAttrs: false, name: 'SunCloudSlowWind02Icon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg) translateX(0px)', 'rotate(-11.48deg) translateX(1.53px)', 'rotate(4.78deg) translateX(-0.38px)', 'rotate(-1.91deg) translateX(0.19px)', 'rotate(0deg) translateX(0px)'],
    transition: {
      duration: 0.67,
      ease: [0.23, 1, 0.32, 1],
    },
