...
defineOptions({ inheritAttrs: false, name: 'Quiz01Icon' })
...
const headVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(15.2deg)', 'rotate(-3.8deg)', 'rotate(0deg)'],
    transition: {
      duration: 0.57,
      ease: 'easeInOut',
      times: [0, 0.4, 0.7, 1],
