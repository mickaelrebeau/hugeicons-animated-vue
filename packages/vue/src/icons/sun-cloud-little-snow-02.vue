...
defineOptions({ inheritAttrs: false, name: 'SunCloudLittleSnow02Icon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['translate(0px, 0px) rotate(0deg)', 'translate(1.41px, 2.22px) rotate(18.17deg)', 'translate(-0.81px, 3.63px) rotate(-8.07deg)', 'translate(0px, 0px) rotate(0deg)'],
    transition: {
      duration: 0.94,
      ease: [0.77, 0, 0.175, 1],
    },
