...
defineOptions({ inheritAttrs: false, name: 'ShutterstockIcon' })
...
// after folder-01: the parts of the shutterstock move from their own mass and settle together
