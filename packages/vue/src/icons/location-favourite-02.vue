...
defineOptions({ inheritAttrs: false, name: 'LocationFavourite02Icon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['translateY(0px) scale(1)', 'translateY(-2.26px) scale(0.96)', 'translateY(0.41px) scale(1.04)', 'translateY(0px) scale(1)'],
    transition: {
      duration: 0.56,
      ease: [0.23, 1, 0.32, 1],
    },
