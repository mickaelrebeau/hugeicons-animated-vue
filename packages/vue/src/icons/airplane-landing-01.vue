...
defineOptions({ inheritAttrs: false, name: 'AirplaneLanding01Icon' })
...
// the airliner climbs back to its approach point, sinks onto the runway and the strip takes the touch
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="hidden">
            <motion.path d="M6.00146 19.9982H22.0015" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="runwayVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '22px 20px' }" />
