...
// the triangle rocks on its base, the inverted bang hanging from the apex
...
const frameVariants: Variants = {
  ...
  animate: {
    ...
    transition: { duration: 0.62, times: [0, 0.2, 0.46, 0.72, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
...
const stemVariants: Variants = {
  ...
  animate: {
    transform: ['scaleY(1)', 'scaleY(0.78)', 'scaleY(1.1)', 'scaleY(1)'],
    transition: { duration: 0.62, delay: 0.06, times: [0, 0.28, 0.62, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
...
const dotVariants: Variants = {
  ...
  animate: {
    transform: ['scale(1)', 'scale(0.7)', 'scale(1.28)', 'scale(1)'],
    transition: { duration: 0.62, times: [0, 0.22, 0.56, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
