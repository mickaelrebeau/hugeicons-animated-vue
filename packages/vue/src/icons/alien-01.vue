...
defineOptions({ inheritAttrs: false, name: 'Alien01Icon' })
...
// the left eye closes first, then the right, and the mouth opens on a tilted head
...
const eyeRightVariants: Variants = {
  ...
  animate: {
    transform: ['scaleY(1)', 'scaleY(0.12)', 'scaleY(1.08)', 'scaleY(1)'],
    transition: { duration: 0.52, delay: 0.14, times: [0, 0.32, 0.68, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
...
const mouthVariants: Variants = {
  ...
  animate: {
    transform: ['scaleX(1)', 'scaleX(0.4)', 'scaleX(1.2)', 'scaleX(1)'],
    transition: { duration: 0.54, delay: 0.22, times: [0, 0.3, 0.66, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
...
const headVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(-3deg)', 'rotate(1.6deg)', 'rotate(0deg)'],
