...
defineOptions({ inheritAttrs: false, name: 'ShoppingBasketAdd01Icon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['translateX(0px)', 'translateX(2.05px)', 'translateX(-0.28px)', 'translateX(0px)'],
    transition: {
      duration: 0.53,
      ease: [0.23, 1, 0.32, 1],
    },
...
const plusVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg) scale(1)', 'rotate(-10.8deg) scale(0.82)', 'rotate(3.24deg) scale(1.08)', 'rotate(0deg) scale(1)'],
    transition: {
      duration: 0.44,
      delay: 0.04,
      ease: [0.23, 1, 0.32, 1],
