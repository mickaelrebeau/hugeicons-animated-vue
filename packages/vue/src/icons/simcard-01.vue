...
defineOptions({ inheritAttrs: false, name: 'Simcard01Icon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['translateX(0px) rotate(0deg)', 'translateX(2.64px) rotate(2.2deg)', 'translateX(-0.33px) rotate(-0.55deg)', 'translateX(0px) rotate(0deg)'],
    transition: {
      duration: 0.59,
      ease: [0.23, 1, 0.32, 1],
    },
