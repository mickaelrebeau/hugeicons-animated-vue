...
defineOptions({ inheritAttrs: false, name: 'CalendarDownloadIcon' })
...
const arrowVariants: Variants = {
  ...
  animate: {
    transform: ['translateY(0px)', 'translateY(5.01px)', 'translateY(-5.01px)', 'translateY(0px)'],
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            ...
            <motion.path d="M15 19.5C15.4915 20.0057 16.7998 22 17.5 22C18.2002 22 19.5085 20.0057 20 19.5M17.5 21.5L17.5 15" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="trayVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '17.5px 18.5px' }" />
