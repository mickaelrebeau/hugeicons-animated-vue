...
defineOptions({ inheritAttrs: false, name: 'MapsSquare01Icon' })
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            ...
            <motion.path d="M14.625 9.5H14.5M14.75 9.5C14.75 9.63807 14.6381 9.75 14.5 9.75C14.3619 9.75 14.25 9.63807 14.25 9.5C14.25 9.36193 14.3619 9.25 14.5 9.25C14.6381 9.25 14.75 9.36193 14.75 9.5Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="iconVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '12px 21.5px' }" />
          </svg>
        </div>
</template>
