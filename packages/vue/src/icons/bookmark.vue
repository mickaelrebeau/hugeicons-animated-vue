...
// the ribbon stretches from the still fold, the crease holding
...
const ribbonVariants: Variants = {
  ...
  animate: {
    transform: [
      ...
      'translate(0px, 1.06px) scaleY(1.2)',
      'translate(0px, 1.06px) scaleY(1.2)',
      'translate(0px, 0.00px) scaleY(1)',
    ],
    transition: {
