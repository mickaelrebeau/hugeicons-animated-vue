...
defineOptions({ inheritAttrs: false, name: 'JupiterIcon' })
...
// after folder-01: the parts of the jupiter move from their own mass and settle together
