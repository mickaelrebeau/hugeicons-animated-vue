...
defineOptions({ inheritAttrs: false, name: 'ThumbsDownRectangleIcon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['translateY(0px) rotate(0deg)', 'translateY(-1.58px) rotate(-3.95deg)', 'translateY(0.3px) rotate(0.99deg)', 'translateY(0px) rotate(0deg)'],
    transition: {
      duration: 0.55,
      ease: [0.23, 1, 0.32, 1],
    },
