...
defineOptions({ inheritAttrs: false, name: 'AlignBoxBottomRightIcon' })
...
// the block slides down-right into the corner of the box
...
const blockVariants: Variants = {
  ...
  animate: {
    transform: [
      ...
      'translate(0.30800000000000005px, 0.30800000000000005px)',
      'translate(0px, 0px)',
    ],
    transition: {
      duration: 0.54,
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            ...
            <motion.path d="M17 12L9 12M17 17H14" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="blockVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '17px 17px' }" />
          </svg>
        </div>
</template>
