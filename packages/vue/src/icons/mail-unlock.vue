...
defineOptions({ inheritAttrs: false, name: 'MailUnlockIcon' })
...
const shackleVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(-18.63deg)', 'rotate(-16.56deg)', 'rotate(0deg)'],
    transition: {
      duration: 0.83,
      ease: [0.77, 0, 0.175, 1],
    },
...
const bodyVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg) scale(1)', 'rotate(-0.95deg) scale(0.985)', 'rotate(1.33deg) scale(1.018)', 'rotate(-0.33deg) scale(0.997)', 'rotate(0deg) scale(1)'],
    transition: {
      duration: 0.68,
