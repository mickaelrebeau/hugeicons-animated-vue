...
defineOptions({ inheritAttrs: false, name: 'SimcardDualIcon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['translateX(0px) rotate(0deg)', 'translateX(2.35px) rotate(1.96deg)', 'translateX(-0.29px) rotate(-0.49deg)', 'translateX(0px) rotate(0deg)'],
    transition: {
      duration: 0.54,
      ease: [0.23, 1, 0.32, 1],
    },
