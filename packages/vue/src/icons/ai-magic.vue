...
defineOptions({ inheritAttrs: false, name: 'AiMagicIcon' })
...
// the two sparks turn against each other, the big one one way, the small one the other
...
const starVariants: Variants = {
  ...
  animate: {
    ...
    transition: { duration: 0.84, times: [0, 0.36, 0.76, 1], ease: [0.23, 1, 0.32, 1] },
  },
};

const sparkSmallVariants: Variants = {
  normal: { transform: 'rotate(0deg) scale(1)' },
  animate: {
    transform: [
      'rotate(0deg) scale(1)',
      'rotate(-46deg) scale(0.6)',
      'rotate(-90deg) scale(1.16)',
      'rotate(-90deg) scale(1)',
    ],
    transition: { duration: 0.84, delay: 0.1, times: [0, 0.36, 0.76, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
