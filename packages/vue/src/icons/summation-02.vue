...
defineOptions({ inheritAttrs: false, name: 'Summation02Icon' })
...
// after folder-01: the parts of the summation move from their own mass and settle together
