...
defineOptions({ inheritAttrs: false, name: 'SystemUpdate02Icon' })
...
// after folder-01: the parts of the system update move from their own mass and settle together
