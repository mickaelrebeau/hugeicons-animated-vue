...
defineOptions({ inheritAttrs: false, name: 'BabyGirlDressIcon' })
...
// the skirt twirls from the waist, the bow bounces on the bodice, the collar stays the hang
