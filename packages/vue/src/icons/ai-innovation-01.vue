...
// the pins carry current, the chip works it through, and the bulb lights last
// authored from scripts/authored
const bulbVariants: Variants = {
  normal: { transform: 'scale(1)', opacity: 1 },
  animate: {
    transform: ['scale(1)', 'scale(0.97)', 'scale(1.04)', 'scale(1)'],
    opacity: [1, 0.5, 1, 1],
    transition: { duration: 0.62, delay: 0.22, times: [0, 0.28, 0.62, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
