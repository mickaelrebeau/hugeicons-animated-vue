...
defineOptions({ inheritAttrs: false, name: 'BubbleChatUploadIcon' })
...
const arrowVariants: Variants = {
  ...
  animate: {
    transform: ['translateY(0px)', 'translateY(-5.41px)', 'translateY(5.41px)', 'translateY(0px)'],
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            ...
            <motion.path d="M15 11.5C15 11.5 12.7905 8.50003 12 8.50002C11.2094 8.50002 9 11.5 9 11.5M12 9.00002V15.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="arrowVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '12px 12px' }" />
          </svg>
        </div>
</template>
