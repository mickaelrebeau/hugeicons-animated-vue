...
defineOptions({ inheritAttrs: false, name: 'FallingStarIcon' })
...
// after folder-01: the parts of the falling star move from their own mass and settle together
