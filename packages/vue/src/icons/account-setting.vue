...
// the cog backs off a notch and the portrait settles the other way
// authored from scripts/authored
const portraitVariants: Variants = {
  normal: { transform: 'translateX(0px)' },
  animate: {
    transform: ['translateX(0px)', 'translateX(-0.45px)', 'translateX(0px)'],
    transition: { duration: 0.5, delay: 0.06, times: [0, 0.4, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
...
const cogVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(-17deg)', 'rotate(3deg)', 'rotate(0deg)'],
    transition: {
      duration: 0.6,
      times: [0, 0.42, 0.74, 1],
      ease: [
