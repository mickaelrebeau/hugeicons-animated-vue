...
defineOptions({ inheritAttrs: false, name: 'SaleTag01Icon' })
...
// after folder-01: the parts of the sale tag move from their own mass and settle together
