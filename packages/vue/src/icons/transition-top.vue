...
defineOptions({ inheritAttrs: false, name: 'TransitionTopIcon' })
...
// after folder-01: the parts of the transition top move from their own mass and settle together
