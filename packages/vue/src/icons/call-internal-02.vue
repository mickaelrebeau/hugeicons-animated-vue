...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(-10.85deg)', 'rotate(8.68deg)', 'rotate(-5.43deg)', 'rotate(0deg)'],
    transition: {
      duration: 0.73,
      ease: 'easeInOut',
    },
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            <motion.path d="M14 6.5H20M19 4.5L21 6.5L19 8.5M15 4.5L13 6.5L15 8.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="iconVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '11.98px 3px' }" />
