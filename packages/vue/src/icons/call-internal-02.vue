...
defineOptions({ inheritAttrs: false, name: 'CallInternal02Icon' })
...
// the arrows trade floors and the handset sways
// authored from scripts/authored
const arrowsVariants: Variants = {
  ...
  animate: {
    ...
    transition: { duration: 0.64, times: [0, 0.32, 0.64, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
...
const handsetVariants: Variants = {
  ...
  animate: {
    ...
    transition: { duration: 0.6, times: [0, 0.34, 0.66, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            <motion.path d="M14 6.5H20M19 4.5L21 6.5L19 8.5M15 4.5L13 6.5L15 8.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="arrowsVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '17px 6.5px' }" />
