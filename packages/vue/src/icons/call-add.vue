...
defineOptions({ inheritAttrs: false, name: 'CallAddIcon' })
...
// the handset lifts and the plus stamps the new call
...
const markVariants: Variants = {
  ...
  animate: {
    ...
    transition: { duration: 0.46, delay: 0.2, times: [0, 0.32, 0.68, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            ...
            <motion.path d="M16.5 4V11M20 7.5H13" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="markVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '16.5px 7.5px' }" />
          </svg>
        </div>
</template>
