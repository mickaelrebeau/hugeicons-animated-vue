...
defineOptions({ inheritAttrs: false, name: 'Chess02Icon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['translateY(0px) scale(1)', 'translateY(-2.12px) scale(0.96)', 'translateY(0.39px) scale(1.04)', 'translateY(0px) scale(1)'],
    transition: {
      duration: 0.54,
      ease: [0.23, 1, 0.32, 1],
    },
