...
defineOptions({ inheritAttrs: false, name: 'CallBlocked02Icon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(-7.4deg)', 'rotate(6.48deg)', 'rotate(-3.7deg)', 'rotate(1.85deg)', 'rotate(0deg)'],
    transition: {
      duration: 0.55,
      ease: [0.77, 0, 0.175, 1],
    },
