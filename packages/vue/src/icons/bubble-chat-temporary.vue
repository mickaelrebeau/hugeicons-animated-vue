...
defineOptions({ inheritAttrs: false, name: 'BubbleChatTemporaryIcon' })
...
// the dashed bubble rewrites and dims, as if the message is expiring
// authored from scripts/authored
const bubbleVariants: Variants = {
  normal: { opacity: 1, pathLength: 1, pathOffset: 0, visibility: 'visible' },
  animate: {
    opacity: [1, 0.4, 1],
    pathLength: [1, 0.14, 1],
    pathOffset: [0, 0.5, 0],
