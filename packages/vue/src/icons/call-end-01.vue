...
defineOptions({ inheritAttrs: false, name: 'CallEnd01Icon' })
...
// the cross slams and the handset hangs up
...
const crossVariants: Variants = {
  ...
  animate: {
    ...
    transition: { duration: 0.5, times: [0, 0.28, 0.6, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            ...
            <motion.path d="M20 4L14 10M20 10L14 4" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="crossVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '17px 7px' }" />
          </svg>
        </div>
</template>
