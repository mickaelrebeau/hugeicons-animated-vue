...
defineOptions({ inheritAttrs: false, name: 'Unlink06Icon' })
...
// after link-01: the two chain halves pull apart along the break and reconnect
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['translateX(0px)', 'translateX(1.35px)', 'translateX(-0.19px)', 'translateX(0px)'],
    transition: {
      duration: 0.46,
      ease: [0.23, 1, 0.32, 1],
    },
