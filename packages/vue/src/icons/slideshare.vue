...
defineOptions({ inheritAttrs: false, name: 'SlideshareIcon' })
...
// after folder-01: the parts of the slideshare move from their own mass and settle together
