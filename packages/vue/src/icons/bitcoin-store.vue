...
defineOptions({ inheritAttrs: false, name: 'BitcoinStoreIcon' })
...
// the awning drops onto the still stall, B already seated
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            ...
            <path d="M3.02002 10.4814V14.9886C3.02002 17.8215 3.02002 19.2379 3.89903 20.118C4.77805 20.9981 6.1928 20.9981 9.02231 20.9981H13.0238" stroke="currentColor" stroke-linecap="round" stroke-width="1.5" />
          </svg>
        </div>
</template>
