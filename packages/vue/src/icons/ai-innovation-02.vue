...
defineOptions({ inheritAttrs: false, name: 'AiInnovation02Icon' })
...
// the letter resolves inside the glass and the dome lights around it
// authored from scripts/authored
const domeVariants: Variants = {
  normal: { transform: 'scale(1)', opacity: 1 },
  animate: {
    transform: ['scale(1)', 'scale(0.972)', 'scale(1.04)', 'scale(1)'],
    opacity: [1, 0.55, 1, 1],
    transition: { duration: 0.62, delay: 0.18, times: [0, 0.28, 0.62, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
...
const collarVariants: Variants = {
  ...
  animate: {
    ...
    transition: { duration: 0.46, delay: 0.24, times: [0, 0.34, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
