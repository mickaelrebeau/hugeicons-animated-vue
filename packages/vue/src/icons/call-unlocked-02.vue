...
// the lock swings open and the handset comes alive
...
const lockVariants: Variants = {
  ...
  animate: {
    transform: [
      ...
      'translate(-1.93px, -1.08px) rotate(-24deg)',
      'translate(-0.59px, -0.45px) rotate(-8deg)',
      'translate(0.00px, 0.00px) rotate(0deg)',
    ],
    transition: {
      duration: 0.68,
