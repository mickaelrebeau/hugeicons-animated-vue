...
defineOptions({ inheritAttrs: false, name: 'GreenHouseIcon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['translateY(0px)', 'translateY(-1.88px)', 'translateY(0px)'],
    transition: {
      duration: 0.53,
      ease: 'easeInOut',
      times: [0, 0.35, 1],
