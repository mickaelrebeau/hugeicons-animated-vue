...
defineOptions({ inheritAttrs: false, name: 'MessageUpload01Icon' })
...
const arrowVariants: Variants = {
  ...
  animate: {
    transform: ['translateY(0px)', 'translateY(-4.78px)', 'translateY(4.78px)', 'translateY(0px)'],
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            ...
            <motion.path d="M17 4.5C17.4915 3.9943 18.7998 2 19.5 2M22 4.5C21.5085 3.9943 20.2002 2 19.5 2M19.5 2V10" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="arrowVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '19.5px 6px' }" />
          </svg>
        </div>
</template>
