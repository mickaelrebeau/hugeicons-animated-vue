...
defineOptions({ inheritAttrs: false, name: 'Pizza01Icon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['translateY(0px) scaleY(1)', 'translateY(1.51px) scaleY(0.82)', 'translateY(-3.67px) scaleY(1.08)', 'translateY(0.54px) scaleY(0.94)', 'translateY(0px) scaleY(1)'],
    transition: {
      duration: 0.71,
