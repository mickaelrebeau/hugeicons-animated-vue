...
defineOptions({ inheritAttrs: false, name: 'WikipediaIcon' })
...
// after folder-01: the parts of the wikipedia move from their own mass and settle together
