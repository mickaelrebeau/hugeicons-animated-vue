...
defineOptions({ inheritAttrs: false, name: 'AirplaneIcon' })
...
const planeVariants: Variants = {
  ...
  animate: {
    transform: ['translate(0px, 0px) rotate(0deg)', 'translate(1.54px, -1.34px) rotate(-6.72deg)', 'translate(3.07px, -0.48px) rotate(-1.92deg)', 'translate(0.38px, 0.34px) rotate(1.15deg)', 'translate(0px, 0px) rotate(0deg)'],
    transition: {
      duration: 0.88,
