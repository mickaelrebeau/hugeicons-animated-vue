...
// the airliner holds altitude and yaws gently, wings rocking through the air
...
const airlinerVariants: Variants = {
  ...
  animate: {
    transform: [
      ...
      'rotate(-2.4deg) translate(0.6px, -0.3px)',
      'rotate(1.6deg) translate(-0.4px, 0.2px)',
      'rotate(-0.6deg) translate(0.15px, 0px)',
      'rotate(0deg) translate(0px, 0px)',
    ],
    transition: { duration: 0.98, times: [0, 0.26, 0.54, 0.78, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
