...
defineOptions({ inheritAttrs: false, name: 'PaintBrush02Icon' })
  ...
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            <motion.g :variants="generatedGeometryVariants" :animate="controls" initial="normal">
              <motion.path d="M10.5 5V9.2" stroke="currentColor" stroke-linecap="butt" stroke-width="12.5" vector-effect="non-scaling-stroke" :variants="paintMarkVariants" :animate="controls" initial="normal" />
            </motion.g>
            <motion.g :variants="brushVariants" :animate="controls" initial="normal" :style="{ transformBox: 'view-box', originX: 0.56, originY: 0.88 }">
