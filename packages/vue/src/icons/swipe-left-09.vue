...
defineOptions({ inheritAttrs: false, name: 'SwipeLeft09Icon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['translateX(0px) rotate(0deg)', 'translateX(3px) rotate(3.76deg)', 'translateX(-0.38px) rotate(-0.94deg)', 'translateX(0px) rotate(0deg)'],
    transition: {
      duration: 0.58,
      ease: [0.23, 1, 0.32, 1],
    },
