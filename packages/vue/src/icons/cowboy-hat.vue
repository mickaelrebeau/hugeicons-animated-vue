...
defineOptions({ inheritAttrs: false, name: 'CowboyHatIcon' })
...
// after wifi-01: the arcs of the cowboy hat propagate outward from their geometric source
