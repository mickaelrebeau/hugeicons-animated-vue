...
defineOptions({ inheritAttrs: false, name: 'AsteroidIcon' })
...
// the big rock tumbles in space, every crater riding with it, while the distant meteor parallax-drifts the other way
...
const rockVariants: Variants = {
  ...
  animate: {
    transform: [
      ...
      'translate(0.00px, 0.00px) rotate(15deg)',
      'translate(0.00px, 0.00px) rotate(-11deg)',
      'translate(0.00px, 0.00px) rotate(4deg)',
      'translate(0.00px, 0.00px) rotate(0deg)',
    ],
    transition: {
      duration: 0.84,
...
const craterAVariants: Variants = {
  normal: { transform: 'translate(0.00px, 0.00px) rotate(0deg)' },
  animate: {
    transform: [
      'translate(0.00px, 0.00px) rotate(0deg)',
      'translate(-0.71px, -0.38px) rotate(15deg)',
      'translate(0.57px, 0.16px) rotate(-11deg)',
      'translate(-0.20px, -0.08px) rotate(4deg)',
      'translate(0.00px, 0.00px) rotate(0deg)',
    ],
    transition: {
      duration: 0.84,
...
const craterBVariants: Variants = {
  normal: { transform: 'translate(0.00px, 0.00px) rotate(0deg)' },
  animate: {
    transform: [
      'translate(0.00px, 0.00px) rotate(0deg)',
      'translate(0.78px, -0.92px) rotate(15deg)',
      'translate(-0.41px, 0.79px) rotate(-11deg)',
      'translate(0.18px, -0.27px) rotate(4deg)',
      'translate(0.00px, 0.00px) rotate(0deg)',
    ],
    transition: {
      duration: 0.84,
...
const pitVariants: Variants = {
  normal: { transform: 'translate(0.00px, 0.00px) rotate(0deg)' },
  animate: {
    transform: [
      'translate(0.00px, 0.00px) rotate(0deg)',
      'translate(-0.31px, 1.17px) rotate(15deg)',
      'translate(0.03px, -0.89px) rotate(-11deg)',
      'translate(-0.05px, 0.32px) rotate(4deg)',
      'translate(0.00px, 0.00px) rotate(0deg)',
    ],
    transition: {
      duration: 0.84,
