...
defineOptions({ inheritAttrs: false, name: 'NotificationIcon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(-14.27deg)', 'rotate(11.21deg)', 'rotate(-8.16deg)', 'rotate(5.1deg)', 'rotate(-2.04deg)', 'rotate(0deg)'],
    transition: {
      duration: 0.9,
      ease: 'easeInOut',
