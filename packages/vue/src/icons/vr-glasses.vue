...
defineOptions({ inheritAttrs: false, name: 'VrGlassesIcon' })
...
// after folder-01: the parts of the vr glasses move from their own mass and settle together
