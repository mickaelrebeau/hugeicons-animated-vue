...
defineOptions({ inheritAttrs: false, name: 'MouseLeftClick01Icon' })
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            <motion.path d="M5 2C3.94531 3.13158 3.23544 4.50113 3 6" stroke="currentColor" stroke-linecap="round" stroke-width="1.5" :variants="clickMarkVariants" :animate="controls" initial="normal" :style="{ originX: 1, originY: 0 }" />
            <motion.g :variants="mousePressVariants" :animate="controls" initial="normal" :style="{ originX: 1, originY: 1 }">
              <path d="M13.5 2L13.5 6M13.5 10L13.5 12" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" />
