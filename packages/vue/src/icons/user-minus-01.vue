...
defineOptions({ inheritAttrs: false, name: 'UserMinus01Icon' })
...
const personVariants: Variants = {
  ...
  animate: {
    transform: ['translateX(0px) scale(1)', 'translateX(-1.59px) scale(0.97)', 'translateX(0.37px) scale(1.01)', 'translateX(0px) scale(1)'],
    transition: {
      duration: 0.56,
      ease: [0.23, 1, 0.32, 1],
    },
...
const removeVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(-10.37deg) scale(0.58)', 'rotate(12.44deg) scale(1.2)', 'rotate(-3.11deg) scale(0.98)', 'rotate(0deg) scale(1)'],
    transition: {
      duration: 0.51,
      delay: 0.06,
      ease: [0.23, 1, 0.32, 1],
