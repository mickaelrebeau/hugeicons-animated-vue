...
defineOptions({ inheritAttrs: false, name: 'Jsx03Icon' })
...
const nibVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg) translate(0px, 0px)', 'rotate(-8.01deg) translate(-0.4px, 0.6px)', 'rotate(4deg) translate(0.3px, -0.3px)', 'rotate(0deg) translate(0px, 0px)'],
    transition: {
      duration: 0.55,
      ease: [0.23, 1, 0.32, 1],
    },
