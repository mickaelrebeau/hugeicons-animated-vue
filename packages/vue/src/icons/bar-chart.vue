...
const tileVariants: Variants = {
  ...
  animate: (i: number) => ({
    transform: ['translateY(1.45px) scale(0.74)', 'translateY(-0.41px) scale(1.1)', 'translateY(0px) scale(1)'],
