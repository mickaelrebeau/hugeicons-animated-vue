...
defineOptions({ inheritAttrs: false, name: 'ChatUnlockIcon' })
...
const bodyVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg) scale(1)', 'rotate(-1.08deg) scale(0.985)', 'rotate(1.51deg) scale(1.018)', 'rotate(-0.38deg) scale(0.997)', 'rotate(0deg) scale(1)'],
    transition: {
      duration: 0.75,
...
const shackleVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(-17.73deg)', 'rotate(-15.76deg)', 'rotate(0deg)'],
    transition: {
      duration: 0.8,
      ease: [0.77, 0, 0.175, 1],
    },
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            ...
            <motion.path d="M10 10V8.5C10 7.39543 10.8954 6.5 12 6.5C12.5523 6.5 13.0523 6.72386 13.4142 7.08579" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="shackleVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '10px 8.25px' }" />
            <motion.path d="M14 10H10C9.17157 10 8.5 10.6716 8.5 11.5V13C8.5 13.8284 9.17157 14.5 10 14.5H14C14.8284 14.5 15.5 13.8284 15.5 13V11.5C15.5 10.6716 14.8284 10 14 10Z" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="folderVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '12px 12px' }" />
          </svg>
        </div>
</template>
