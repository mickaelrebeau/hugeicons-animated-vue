...
defineOptions({ inheritAttrs: false, name: 'UserStar02Icon' })
...
const headVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(15.6deg)', 'rotate(-3.9deg)', 'rotate(0deg)'],
    transition: {
      duration: 0.58,
      ease: 'easeInOut',
      times: [0, 0.4, 0.7, 1],
