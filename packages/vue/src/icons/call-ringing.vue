...
defineOptions({ inheritAttrs: false, name: 'CallRingingIcon' })
...
// the waves rush outward while the cradle stays planted
...
const wavesVariants: Variants = {
  ...
  animate: {
    ...
    transition: { duration: 0.72, times: [0, 0.18, 0.42, 0.68, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
