...
defineOptions({ inheritAttrs: false, name: 'BoxingGlove01Icon' })
...
// the glove winds back, jabs up-right and recoils
// authored from scripts/authored
const gloveVariants: Variants = {
