...
defineOptions({ inheritAttrs: false, name: 'RotateLeft02Icon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(-24.03deg)', 'rotate(360deg)'],
    transition: {
      duration: 0.86,
      times: [0, 0.2, 1],
      ease: ['easeIn', 'easeOut'],
