...
// the bell and clapper nod from the crown as one piece
...
const clapperVariants: Variants = {
  ...
  animate: {
    transform: [
      ...
      'translate(-1.57px, -0.07px) rotate(5deg)',
      'translate(1.26px, -0.04px) rotate(-4deg)',
      'translate(-0.47px, -0.01px) rotate(1.5deg)',
      'translate(0.00px, 0.00px) rotate(0deg)',
    ],
    transition: {
      duration: 0.7,
...
const bodyVariants: Variants = {
  ...
  animate: {
    transform: [
      'translate(0.00px, 0.00px) rotate(0deg)',
      'translate(-0.70px, -0.03px) rotate(5deg)',
      'translate(0.56px, -0.02px) rotate(-4deg)',
      'translate(-0.21px, -0.00px) rotate(1.5deg)',
      'translate(0.00px, 0.00px) rotate(0deg)',
    ],
    transition: {
      duration: 0.7,
