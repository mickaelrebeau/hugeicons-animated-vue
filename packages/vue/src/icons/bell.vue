...
defineOptions({ inheritAttrs: false, name: 'BellIcon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(-14.62deg)', 'rotate(11.49deg)', 'rotate(-8.35deg)', 'rotate(5.22deg)', 'rotate(-2.09deg)', 'rotate(0deg)'],
    transition: {
      duration: 0.91,
      ease: 'easeInOut',
