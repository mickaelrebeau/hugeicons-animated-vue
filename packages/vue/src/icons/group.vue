...
defineOptions({ inheritAttrs: false, name: 'GroupIcon' })
...
const personVariants: Variants = {
  ...
  animate: {
    transform: ['translateY(0px) scale(1)', 'translateY(-1.49px) scale(1.03)', 'translateY(0.5px) scale(0.98)', 'translateY(0px) scale(1)'],
    transition: {
      duration: 0.55,
      ease: [0.23, 1, 0.32, 1],
    },
...
const personVariants2: Variants = {
  ...
  animate: {
    transform: ['translateX(0px) scale(1)', 'translateX(-1.49px) scale(0.97)', 'translateX(0.35px) scale(1.01)', 'translateX(0px) scale(1)'],
    transition: {
      duration: 0.53,
      ease: [0.23, 1, 0.32, 1],
    },
