...
defineOptions({ inheritAttrs: false, name: 'ExchangeIcon' })
...
// after edit-02: the open stroke of the exchange writes along the direction of its path
...
const nibVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg) translate(0px, 0px)', 'rotate(-7.43deg) translate(-0.37px, 0.56px)', 'rotate(3.71deg) translate(0.28px, -0.28px)', 'rotate(0deg) translate(0px, 0px)'],
    transition: {
      duration: 0.6,
      ease: [0.23, 1, 0.32, 1],
    },
