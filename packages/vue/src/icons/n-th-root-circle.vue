...
defineOptions({ inheritAttrs: false, name: 'NThRootCircleIcon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(-8.72deg)', 'rotate(3.27deg)', 'rotate(0deg)'],
    transition: {
      duration: 0.59,
      ease: [0.23, 1, 0.32, 1],
    },
