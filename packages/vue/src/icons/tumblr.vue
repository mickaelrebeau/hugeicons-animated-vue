...
defineOptions({ inheritAttrs: false, name: 'TumblrIcon' })
...
// after home-01: the silhouette of the tumblr loads onto its base and settles with weight
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['translateY(0px) scaleY(1)', 'translateY(1.44px) scaleY(0.82)', 'translateY(-3.49px) scaleY(1.08)', 'translateY(0.51px) scaleY(0.94)', 'translateY(0px) scaleY(1)'],
    transition: {
      duration: 0.68,
