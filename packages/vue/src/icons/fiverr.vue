...
defineOptions({ inheritAttrs: false, name: 'FiverrIcon' })
...
// after home-01: the silhouette of the fiverr loads onto its base and settles with weight
