...
defineOptions({ inheritAttrs: false, name: 'JoinRoundIcon' })
...
// after home-01: the silhouette of the join round loads onto its base and settles with weight
