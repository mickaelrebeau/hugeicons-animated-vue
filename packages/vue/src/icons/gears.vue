...
defineOptions({ inheritAttrs: false, name: 'GearsIcon' })
...
// after dashboard-square-01: the separate cells of the gears assemble from top-left to bottom-right
