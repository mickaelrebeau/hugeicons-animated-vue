...
defineOptions({ inheritAttrs: false, name: 'KnifeBreadIcon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(-22.45deg)', 'rotate(8.16deg)', 'rotate(-2.04deg)', 'rotate(0deg)'],
    transition: {
      duration: 0.52,
