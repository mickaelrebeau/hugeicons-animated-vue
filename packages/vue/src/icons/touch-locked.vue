...
defineOptions({ inheritAttrs: false, name: 'TouchLockedIcon' })
...
// after mouse-left-click-01: the touch point compresses and sends the response outward
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['translateX(0px) scaleX(1) scaleY(1)', 'translateX(-0.76px) scaleX(0.9) scaleY(1.04)', 'translateX(1.9px) scaleX(1.1) scaleY(0.97)', 'translateX(0px) scaleX(1) scaleY(1)'],
    transition: {
      duration: 0.49,
      ease: [0.23, 1, 0.32, 1],
    },
