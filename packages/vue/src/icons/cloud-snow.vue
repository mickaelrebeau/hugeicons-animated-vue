...
defineOptions({ inheritAttrs: false, name: 'CloudSnowIcon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['translate(0px, 0px) rotate(0deg)', 'translate(1.4px, 2.19px) rotate(17.95deg)', 'translate(-0.8px, 3.59px) rotate(-7.98deg)', 'translate(0px, 0px) rotate(0deg)'],
    transition: {
      duration: 0.93,
      ease: [0.77, 0, 0.175, 1],
    },
