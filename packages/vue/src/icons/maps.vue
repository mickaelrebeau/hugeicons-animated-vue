...
defineOptions({ inheritAttrs: false, name: 'MapsIcon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['translateY(0px) scale(1)', 'translateY(-2.3px) scale(0.96)', 'translateY(0.42px) scale(1.04)', 'translateY(0px) scale(1)'],
    transition: {
      duration: 0.57,
      ease: [0.23, 1, 0.32, 1],
    },
