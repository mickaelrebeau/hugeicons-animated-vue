...
defineOptions({ inheritAttrs: false, name: 'Sheriff02Icon' })
...
// after copy-01: the nested parts of the sheriff separate in depth and stack again
...
const frontVariants: Variants = {
  ...
  animate: {
    transform: ['translate(0px, 0px)', 'translate(1.44px, -1.24px)', 'translate(0.21px, -0.21px)', 'translate(0px, 0px)'],
    transition: {
      duration: 0.52,
      ease: [0.23, 1, 0.32, 1],
    },
