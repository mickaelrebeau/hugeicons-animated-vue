...
// the square makes room and the mark resolves at its centre
// authored from scripts/authored
const squareVariants: Variants = {
  normal: { transform: 'scale(1)' },
  animate: {
    transform: ['scale(1)', 'scale(0.955)', 'scale(1.022)', 'scale(1)'],
...
const plusVariants: Variants = {
  ...
  animate: {
    ...
    transition: { duration: 0.46, delay: 0.05, times: [0, 0.32, 0.68, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
