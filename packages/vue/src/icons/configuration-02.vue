...
defineOptions({ inheritAttrs: false, name: 'Configuration02Icon' })
...
// after folder-01: the parts of the configuration move from their own mass and settle together
