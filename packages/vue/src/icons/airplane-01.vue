...
// the airliner pitches up and surges along its own heading, up and to the right
...
const airlinerVariants: Variants = {
  ...
  animate: {
    transform: [
      ...
      'translate(4%, -2.6%) rotate(-1.6deg)',
      'translate(13%, -8.4%) rotate(-3.4deg)',
      'translate(3%, -1.8%) rotate(-0.8deg)',
      'translate(0%, 0%) rotate(0deg)',
    ],
    transition: {
      duration: 1.02,
