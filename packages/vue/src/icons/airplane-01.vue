...
defineOptions({ inheritAttrs: false, name: 'Airplane01Icon' })
...
const planeVariants: Variants = {
  ...
  animate: {
    transform: ['translate(0px, 0px) rotate(0deg)', 'translate(1.61px, -1.41px) rotate(-7.04deg)', 'translate(3.22px, -0.5px) rotate(-2.01deg)', 'translate(0.4px, 0.35px) rotate(1.21deg)', 'translate(0px, 0px) rotate(0deg)'],
    transition: {
      duration: 0.91,
