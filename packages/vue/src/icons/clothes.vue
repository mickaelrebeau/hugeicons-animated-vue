...
defineOptions({ inheritAttrs: false, name: 'ClothesIcon' })
...
// after folder-01: the parts of the clothes move from their own mass and settle together
