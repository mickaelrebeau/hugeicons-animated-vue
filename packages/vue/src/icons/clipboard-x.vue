...
defineOptions({ inheritAttrs: false, name: 'ClipboardXIcon' })
...
// after folder-01: the parts of the clipboard x move from their own mass and settle together
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            <motion.path d="M14.4839 10.5L11.9922 12.9958M11.9922 12.9958L9.49223 15.5M11.9922 12.9958L14.4922 15.5M11.9922 12.9958L9.50055 10.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="folderVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '12px 22px' }" />
