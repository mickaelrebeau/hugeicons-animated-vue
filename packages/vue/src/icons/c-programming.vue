...
defineOptions({ inheritAttrs: false, name: 'CProgrammingIcon' })
...
// after folder-01: the parts of the c programming move from their own mass and settle together
