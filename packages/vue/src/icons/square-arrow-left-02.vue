...
defineOptions({ inheritAttrs: false, name: 'SquareArrowLeft02Icon' })
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            ...
            <motion.path d="M9.00008 12.0001L16.0001 12.0001M11.4999 8.50006C11.4999 8.50006 7.99995 11.0778 7.99994 12.0001C7.99993 12.9224 11.4999 15.5001 11.4999 15.5001" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="arrowVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '12px 12px' }" />
          </svg>
        </div>
</template>
