...
defineOptions({ inheritAttrs: false, name: 'BookBookmarkIcon' })
...
// the page ribbon stretches from the still head into the cover, curl holding
...
const ribbonVariants: Variants = {
  ...
  animate: {
    transform: [
      ...
      'translate(0px, 1.28px) scaleY(1.32)',
      'translate(0px, 1.28px) scaleY(1.32)',
      'translate(0px, 0.00px) scaleY(1)',
    ],
    transition: {
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            ...
            <motion.path d="M9 4V12L12 9L15 12V4" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="ribbonVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '12px 8px' }" />
