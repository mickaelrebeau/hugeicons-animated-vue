...
defineOptions({ inheritAttrs: false, name: 'CameraOffIcon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg) translateY(0px)', 'rotate(-7.86deg) translateY(0.39px)', 'rotate(0deg) translateY(1.18px)', 'rotate(0deg) translateY(0px)'],
    opacity: [1, 1, 0.55, 1],
    transition: {
      duration: 0.68,
      ease: [0.77, 0, 0.175, 1],
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            <motion.path d="M9.71586 9.71484C8.6787 10.4376 8 11.639 8 12.999C8 15.2081 9.79086 16.999 12 16.999C13.36 16.999 14.5614 16.3203 15.2841 15.2831" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="markVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '11.64px 13.36px' }" />
