...
// the yen glyph rewrites on the still badge
// authored from scripts/authored
const yenVariants: Variants = {
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            ...
            <motion.path d="M9 8C9.2 8.9167 10.08 10.5 12 11.5M12 11.5C13.92 10.5 14.8 8.9167 15 8M12 11.5V17.0002M14.5 13.6827H9.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="yenVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '12px 12.5px' }" />
          </svg>
        </div>
</template>
