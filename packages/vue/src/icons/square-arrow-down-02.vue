...
defineOptions({ inheritAttrs: false, name: 'SquareArrowDown02Icon' })
...
const arrowVariants: Variants = {
  ...
  animate: {
    transform: ['translateY(0px) scaleX(1)', 'translateY(2.67px) scaleX(0.94)', 'translateY(-0.31px) scaleX(1.02)', 'translateY(0.46px) scaleX(0.99)', 'translateY(0px) scaleX(1)'],
    transition: {
      duration: 0.5,
      ease: [0.23, 1, 0.32, 1],
    },
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            ...
            <motion.path d="M12 15V8M15.5 12.5002C15.5 12.5002 12.9223 16.0002 12 16.0002C11.0777 16.0002 8.5 12.5002 8.5 12.5002" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="arrowVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '12px 12px' }" />
          </svg>
        </div>
</template>
