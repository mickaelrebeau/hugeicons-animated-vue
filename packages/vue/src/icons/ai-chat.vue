...
defineOptions({ inheritAttrs: false, name: 'AiChatIcon' })
...
// the bubble bobs up as it arrives and the chip breathes inside it
...
const chipVariants: Variants = {
  ...
  animate: {
    ...
    opacity: [1, 0.7, 1],
    transition: { duration: 0.62, delay: 0.08, times: [0, 0.4, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
