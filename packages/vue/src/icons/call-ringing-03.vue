...
defineOptions({ inheritAttrs: false, name: 'CallRinging03Icon' })
...
// the waves bloom above a handset that jumps
...
const handsetVariants: Variants = {
  ...
  animate: {
    ...
    transition: { duration: 0.56, delay: 0.08, times: [0, 0.34, 0.64, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
