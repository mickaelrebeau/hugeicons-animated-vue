...
defineOptions({ inheritAttrs: false, name: 'EraserAutoIcon' })
...
// after folder-01: the parts of the eraser auto move from their own mass and settle together
