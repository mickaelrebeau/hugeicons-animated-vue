...
defineOptions({ inheritAttrs: false, name: 'Airpod03Icon' })
...
// the left bud seats first, then the right — a pair going in
// authored from scripts/authored
const budLeftVariants: Variants = {
  normal: { transform: 'rotate(0deg) scale(1)' },
  animate: {
    transform: [
      'rotate(0deg) scale(1)',
      'rotate(-5.5deg) scale(0.96)',
      'rotate(1.4deg) scale(1.015)',
      'rotate(0deg) scale(1)',
    ],
...
const budRightVariants: Variants = {
  normal: { transform: 'rotate(0deg) scale(1)' },
  animate: {
    transform: [
      'rotate(0deg) scale(1)',
    ...
    transition: { duration: 0.6, delay: 0.14, times: [0, 0.34, 0.7, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
