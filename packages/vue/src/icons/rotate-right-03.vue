...
defineOptions({ inheritAttrs: false, name: 'RotateRight03Icon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(-26.29deg)', 'rotate(360deg)'],
    transition: {
      duration: 0.92,
      times: [0, 0.2, 1],
      ease: ['easeIn', 'easeOut'],
