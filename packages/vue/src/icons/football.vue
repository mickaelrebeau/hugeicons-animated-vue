...
defineOptions({ inheritAttrs: false, name: 'FootballIcon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['translateY(0px) scaleY(1)', 'translateY(1.41px) scaleY(0.82)', 'translateY(-3.41px) scaleY(1.08)', 'translateY(0.5px) scaleY(0.94)', 'translateY(0px) scaleY(1)'],
    transition: {
      duration: 0.67,
