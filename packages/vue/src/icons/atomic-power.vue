...
defineOptions({ inheritAttrs: false, name: 'AtomicPowerIcon' })
...
// the lightning bolt writes through the core, then both orbits take the shockwave outward
