...
defineOptions({ inheritAttrs: false, name: 'HighlighterIcon' })
...
// after edit-02: the open stroke of the highlighter writes along the direction of its path
