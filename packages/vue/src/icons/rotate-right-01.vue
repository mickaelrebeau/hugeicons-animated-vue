...
defineOptions({ inheritAttrs: false, name: 'RotateRight01Icon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(-23.72deg)', 'rotate(360deg)'],
    transition: {
      duration: 0.85,
      times: [0, 0.2, 1],
      ease: ['easeIn', 'easeOut'],
