...
defineOptions({ inheritAttrs: false, name: 'BluetoothSearchIcon' })
...
// the loupe swings from its handle, the rune holding
...
const lensVariants: Variants = {
  ...
  animate: {
    transform: [
      ...
      'translate(0.36px, -0.33px) rotate(5deg)',
      'translate(-0.27px, 0.29px) rotate(-4deg)',
      'translate(0.11px, -0.10px) rotate(1.5deg)',
      'translate(0.00px, 0.00px) rotate(0deg)',
    ],
    transition: {
      duration: 0.7,
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            ...
            <motion.path d="M19.6322 19.1589L21.5 21M20.7074 16.5964C20.7074 18.5826 19.094 20.1928 17.1037 20.1928C15.1134 20.1928 13.5 18.5826 13.5 16.5964C13.5 14.6102 15.1134 13 17.1037 13C19.094 13 20.7074 14.6102 20.7074 16.5964Z" stroke="currentColor" stroke-linecap="round" stroke-width="1.5" :variants="lensVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '17.5px 17px' }" />
          </svg>
        </div>
</template>
