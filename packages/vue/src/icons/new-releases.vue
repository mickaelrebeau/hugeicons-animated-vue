...
defineOptions({ inheritAttrs: false, name: 'NewReleasesIcon' })
...
const plusVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg) scale(1)', 'rotate(-10.73deg) scale(0.82)', 'rotate(3.22deg) scale(1.08)', 'rotate(0deg) scale(1)'],
    transition: {
      duration: 0.44,
      delay: 0.04,
      ease: [0.23, 1, 0.32, 1],
