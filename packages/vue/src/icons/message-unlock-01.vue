...
defineOptions({ inheritAttrs: false, name: 'MessageUnlock01Icon' })
...
const bodyVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg) scale(1)', 'rotate(-1.05deg) scale(0.985)', 'rotate(1.46deg) scale(1.018)', 'rotate(-0.37deg) scale(0.997)', 'rotate(0deg) scale(1)'],
    transition: {
      duration: 0.73,
...
const shackleVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(-17.17deg)', 'rotate(-15.27deg)', 'rotate(0deg)'],
    transition: {
      duration: 0.78,
      ease: [0.77, 0, 0.175, 1],
    },
