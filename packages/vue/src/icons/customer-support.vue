...
defineOptions({ inheritAttrs: false, name: 'CustomerSupportIcon' })
...
const headVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(17.02deg)', 'rotate(-4.25deg)', 'rotate(0deg)'],
    transition: {
      duration: 0.62,
      ease: 'easeInOut',
      times: [0, 0.4, 0.7, 1],
