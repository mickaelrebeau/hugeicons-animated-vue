...
defineOptions({ inheritAttrs: false, name: 'ReceiptRussianRubleIcon' })
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            ...
            <motion.path d="M10.5 11.5V8.5C10.5 7.94772 10.9477 7.5 11.5 7.5H13.5C14.6046 7.5 15.5 8.39543 15.5 9.5C15.5 10.6046 14.6046 11.5 13.5 11.5H10.5ZM10.5 11.5V14.5M10.5 11.5H8.5M10.5 14.5V16.5M10.5 14.5H8.5M10.5 14.5H13.5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="fileVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '12px 12px' }" />
          </svg>
        </div>
</template>
