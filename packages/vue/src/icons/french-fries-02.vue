...
defineOptions({ inheritAttrs: false, name: 'FrenchFries02Icon' })
...
// after grid-view: the pieces of the french fries take turns from their own geometric centers
