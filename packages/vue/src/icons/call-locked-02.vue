...
// the lock clamps down and the handset freezes dim
...
const handsetVariants: Variants = {
  ...
  animate: {
    opacity: [1, 0.45, 1],
    transition: { duration: 0.64, delay: 0.12, times: [0, 0.45, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
