...
defineOptions({ inheritAttrs: false, name: 'PackageOutOfStockIcon' })
...
const barVariants: Variants = {
  ...
  animate: (i: number) => ({
    transform: ['translateY(2.34px) scaleY(0.6)', 'translateY(-0.53px) scaleY(1.08)', 'translateY(0px) scaleY(1)'],
