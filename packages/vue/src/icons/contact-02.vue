...
defineOptions({ inheritAttrs: false, name: 'Contact02Icon' })
...
const headVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(16.07deg)', 'rotate(-4.02deg)', 'rotate(0deg)'],
    transition: {
      duration: 0.59,
      ease: 'easeInOut',
      times: [0, 0.4, 0.7, 1],
