...
defineOptions({ inheritAttrs: false, name: 'DentalToothIcon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['scale(1) rotate(0deg)', 'scale(0.94) rotate(-3.22deg)', 'scale(1.08) rotate(2.15deg)', 'scale(1) rotate(0deg)'],
    transition: {
      duration: 0.62,
      ease: [0.23, 1, 0.32, 1],
    },
