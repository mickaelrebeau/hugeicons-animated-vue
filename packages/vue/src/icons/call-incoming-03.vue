...
defineOptions({ inheritAttrs: false, name: 'CallIncoming03Icon' })
...
const arrowVariants: Variants = {
  ...
  animate: {
    transform: ['translateX(-3.13px)', 'translateX(1.04px)', 'translateX(-0.31px)', 'translateX(0px)'],
    transition: {
      duration: 0.57,
      ease: [0.23, 1, 0.32, 1],
    },
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            <motion.path d="M16.5 3L14 5.5L16.5 8M21 5.5H14.6088" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="arrowVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '17.5px 5.5px' }" />
