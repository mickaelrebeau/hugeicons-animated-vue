...
defineOptions({ inheritAttrs: false, name: 'BookmarkOffIcon' })
...
const markVariants: Variants = {
  ...
  animate: {
    transform: ['scale(1) rotate(0deg)', 'scale(0.86) rotate(-2.05deg)', 'scale(1.08) rotate(0.82deg)', 'scale(1) rotate(0deg)'],
    transition: {
      duration: 0.52,
      ease: [0.23, 1, 0.32, 1],
    },
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg) translateY(0px)', 'rotate(-7.51deg) translateY(0.38px)', 'rotate(0deg) translateY(1.13px)', 'rotate(0deg) translateY(0px)'],
    opacity: [1, 1, 0.55, 1],
    transition: {
      duration: 0.66,
      ease: [0.77, 0, 0.175, 1],
