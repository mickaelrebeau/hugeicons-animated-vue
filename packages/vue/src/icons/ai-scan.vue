...
defineOptions({ inheritAttrs: false, name: 'AiScanIcon' })
...
// the corner brackets close in to lock focus and the subject pops into the frame
// authored from scripts/authored
const bracketsVariants: Variants = {
  normal: { transform: 'scale(1)' },
  animate: {
    transform: ['scale(1)', 'scale(0.93)', 'scale(1.015)', 'scale(1)'],
...
const subjectVariants: Variants = {
  ...
  animate: {
    ...
    opacity: [1, 0.5, 1, 1],
    transition: { duration: 0.56, delay: 0.14, times: [0, 0.32, 0.68, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
