...
defineOptions({ inheritAttrs: false, name: 'TwoFactorAccessIcon' })
...
// after copy-01: the nested parts of the two factor access separate in depth and stack again
...
const frontVariants: Variants = {
  ...
  animate: {
    transform: ['translate(0px, 0px)', 'translate(1.35px, -1.16px)', 'translate(0.19px, -0.19px)', 'translate(0px, 0px)'],
    transition: {
      duration: 0.5,
      ease: [0.23, 1, 0.32, 1],
    },
