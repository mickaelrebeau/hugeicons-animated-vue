...
defineOptions({ inheritAttrs: false, name: 'AirplaneTakeOff02Icon' })
...
// a rolling start down the strip, then a long flat climb away to the left
// authored from scripts/authored
const runwayVariants: Variants = {
  normal: { transform: 'scaleX(1)' },
  animate: {
    transform: ['scaleX(1)', 'scaleX(0.86)', 'scaleX(1.02)', 'scaleX(1)'],
    transition: { duration: 1.04, times: [0, 0.3, 0.62, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
...
const airlinerVariants: Variants = {
  ...
  animate: {
    transform: [
      ...
      'translate(-3%, -0.8%) rotate(1.4deg)',
      'translate(-11%, -6%) rotate(3.6deg)',
      'translate(-17%, -10%) rotate(4.2deg)',
      'translate(-5%, -3%) rotate(1.2deg)',
      'translate(0%, 0%) rotate(0deg)',
    ],
    transition: {
      duration: 1.04,
      times: [0, 0.18, 0.4, 0.56, 0.82, 1],
      ease: [
        [0.23, 1, 0.32, 1],
        'linear',
        'linear',
