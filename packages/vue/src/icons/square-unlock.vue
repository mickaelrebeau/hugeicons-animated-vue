...
defineOptions({ inheritAttrs: false, name: 'SquareUnlockIcon' })
...
const bodyVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg) scale(1)', 'rotate(-0.96deg) scale(0.985)', 'rotate(1.35deg) scale(1.018)', 'rotate(-0.34deg) scale(0.997)', 'rotate(0deg) scale(1)'],
    transition: {
      duration: 0.69,
...
const shackleVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(-18.94deg)', 'rotate(-16.83deg)', 'rotate(0deg)'],
    transition: {
      duration: 0.84,
      ease: [0.77, 0, 0.175, 1],
    },
