...
defineOptions({ inheritAttrs: false, name: 'Archive04Icon' })
...
// the drawer pulls forward on its seam, then seats back
...
const seamVariants: Variants = {
  ...
  animate: {
    ...
    transition: { duration: 0.64, times: [0, 0.4, 0.74, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            <motion.path d="M13.9378 3H10.0622C8.09477 3 7.11106 3 6.34921 3.5158C5.58736 4.0316 5.22202 4.94495 4.49134 6.77166L2.42914 11.9272C2.21522 12.4619 2.10826 12.7293 2.05413 13.0104C2 13.2915 2 13.5795 2 14.1555V15C2 17.8284 2 19.2426 2.87868 20.1213C3.75736 21 5.17157 21 8 21H16C18.8284 21 20.2426 21 21.1213 20.1213C22 19.2426 22 17.8284 22 15V14.1555C22 13.5795 22 13.2915 21.9459 13.0104C21.8917 12.7294 21.7848 12.4619 21.5709 11.9271L19.5087 6.77166C18.778 4.94495 18.4126 4.0316 17.6508 3.5158C16.8889 3 15.9052 3 13.9378 3Z" stroke="currentColor" stroke-width="1.5" :variants="bodyVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '12px 12px' }" />
