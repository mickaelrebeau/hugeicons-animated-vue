...
defineOptions({ inheritAttrs: false, name: 'CallIncoming04Icon' })
...
const arrowVariants: Variants = {
  ...
  animate: {
    transform: ['translateX(-2.9px)', 'translateX(0.97px)', 'translateX(-0.29px)', 'translateX(0px)'],
    transition: {
      duration: 0.54,
      ease: [0.23, 1, 0.32, 1],
    },
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            <motion.path d="M15 5V9H19M21 3L15.4059 8.59414" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="arrowVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '18px 6px' }" />
