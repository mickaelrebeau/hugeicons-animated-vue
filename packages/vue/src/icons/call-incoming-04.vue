...
// the missed cross falls onto a handset that does not rise
...
const handsetVariants: Variants = {
  ...
  animate: {
    opacity: [1, 0.4, 1],
    transition: { duration: 0.56, times: [0, 0.4, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            <motion.path d="M15 5V9H19M21 3L15.4059 8.59414" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="crossVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '18px 3px' }" />
