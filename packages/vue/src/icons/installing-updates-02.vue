...
defineOptions({ inheritAttrs: false, name: 'InstallingUpdates02Icon' })
...
const frontVariants: Variants = {
  ...
  animate: {
    transform: ['translate(0px, 0px)', 'translate(1.54px, -1.32px)', 'translate(0.22px, -0.22px)', 'translate(0px, 0px)'],
    transition: {
      duration: 0.55,
      ease: [0.23, 1, 0.32, 1],
    },
