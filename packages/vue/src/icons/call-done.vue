...
// the handset nods as the check stamps
// authored from scripts/authored
const handsetVariants: Variants = {
  normal: { transform: 'rotate(0deg)' },
  animate: {
    transform: ['rotate(0deg)', 'rotate(-8deg)', 'rotate(4deg)', 'rotate(0deg)'],
    transition: { duration: 0.52, delay: 0.08, times: [0, 0.34, 0.66, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            ...
            <motion.path d="M13 9C13 9 14.1429 9 15.2857 11C15.2857 11 17.7731 6 21 5" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="checkVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '17px 8px' }" />
          </svg>
        </div>
</template>
