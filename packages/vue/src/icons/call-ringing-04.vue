...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(-15.05deg)', 'rotate(11.82deg)', 'rotate(-8.6deg)', 'rotate(5.37deg)', 'rotate(-2.15deg)', 'rotate(0deg)'],
    transition: {
      duration: 0.93,
      ease: 'easeInOut',
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            <motion.path d="M14 3V6M19 5L17 7M21 10H18" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="iconVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '11.98px 3px' }" />
