...
defineOptions({ inheritAttrs: false, name: 'CallRinging04Icon' })
...
// the corner waves flare and the handset gives one shake
...
const wavesVariants: Variants = {
  ...
  animate: {
    ...
    opacity: [1, 0.4, 1, 1],
    transition: { duration: 0.62, times: [0, 0.28, 0.6, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
...
const handsetVariants: Variants = {
  ...
  animate: {
    ...
    transition: { duration: 0.52, delay: 0.06, times: [0, 0.18, 0.4, 0.64, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            <motion.path d="M14 3V6M19 5L17 7M21 10H18" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="wavesVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '14px 10px' }" />
