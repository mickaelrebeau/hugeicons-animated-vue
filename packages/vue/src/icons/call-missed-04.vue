...
defineOptions({ inheritAttrs: false, name: 'CallMissed04Icon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(-10.04deg)', 'rotate(8.03deg)', 'rotate(-5.02deg)', 'rotate(0deg)'],
    transition: {
      duration: 0.69,
      ease: 'easeInOut',
    },
