...
defineOptions({ inheritAttrs: false, name: 'CallOutgoing03Icon' })
...
const arrowVariants: Variants = {
  ...
  animate: {
    transform: ['translateX(0px)', 'translateX(2.96px)', 'translateX(-0.3px)', 'translateX(0px)'],
    transition: {
      duration: 0.55,
      ease: [0.23, 1, 0.32, 1],
    },
