...
defineOptions({ inheritAttrs: false, name: 'AirplaneModeIcon' })
...
// the aircraft lifts straight up the way its nose points, and settles back level
...
const airlinerVariants: Variants = {
  ...
  animate: {
    transform: [
      ...
      'translateY(-2.2px) rotate(-1.4deg)',
      'translateY(0.3px) rotate(0.4deg)',
      'translateY(0px) rotate(0deg)',
    ],
    transition: {
      duration: 0.82,
