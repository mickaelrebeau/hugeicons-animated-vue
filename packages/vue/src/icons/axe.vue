...
// after scissor-01: it winds up and bites into the cut
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(-22.65deg)', 'rotate(8.24deg)', 'rotate(-2.06deg)', 'rotate(0deg)'],
    transition: {
      duration: 0.52,
