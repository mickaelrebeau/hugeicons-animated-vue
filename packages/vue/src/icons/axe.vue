...
defineOptions({ inheritAttrs: false, name: 'AxeIcon' })
...
// the axe winds up and delivers one chop around the grip
...
const bladeVariants: Variants = {
  ...
  animate: {
    transform: [
      ...
      'translate(-3.74px, -3.82px) rotate(-22deg)',
      'translate(1.81px, 3.99px) rotate(18deg)',
      'translate(0.63px, 1.05px) rotate(5deg)',
      'translate(0.00px, 0.00px) rotate(0deg)',
    ],
    transition: {
      duration: 0.66,
...
const handleVariants: Variants = {
  ...
  animate: {
    transform: [
      'translate(0.00px, 0.00px) rotate(0deg)',
      'translate(-1.53px, -1.06px) rotate(-22deg)',
      'translate(0.88px, 1.25px) rotate(18deg)',
      'translate(0.28px, 0.32px) rotate(5deg)',
      'translate(0.00px, 0.00px) rotate(0deg)',
    ],
    transition: {
      duration: 0.66,
