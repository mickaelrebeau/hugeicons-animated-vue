...
defineOptions({ inheritAttrs: false, name: 'PunchIcon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(-22.57deg)', 'rotate(8.21deg)', 'rotate(-2.05deg)', 'rotate(0deg)'],
    transition: {
      duration: 0.52,
