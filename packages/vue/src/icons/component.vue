...
defineOptions({ inheritAttrs: false, name: 'ComponentIcon' })
...
// after dashboard-square-01: the separate cells of the component assemble from top-left to bottom-right
