...
defineOptions({ inheritAttrs: false, name: 'CreditCardFreezeIcon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['translate(0px, 0px) rotate(0deg)', 'translate(1.36px, 2.14px) rotate(17.5deg)', 'translate(-0.78px, 3.5px) rotate(-7.78deg)', 'translate(0px, 0px) rotate(0deg)'],
    transition: {
      duration: 0.92,
      ease: [0.77, 0, 0.175, 1],
    },
