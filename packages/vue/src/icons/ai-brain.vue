...
defineOptions({ inheritAttrs: false, name: 'AiBrainIcon' })
...
// both hemispheres breathe together and part slightly at the midline
// authored from scripts/authored
const leftLobeVariants: Variants = {
  normal: { transform: 'translateX(0px) scale(1)' },
  animate: {
    transform: ['translateX(0px) scale(1)', 'translateX(-0.7px) scale(1.03)', 'translateX(0px) scale(1)'],
    transition: { duration: 0.66, times: [0, 0.38, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
