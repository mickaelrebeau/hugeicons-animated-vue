...
defineOptions({ inheritAttrs: false, name: 'CircleUnlock01Icon' })
...
const bodyVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg) scale(1)', 'rotate(-1.06deg) scale(0.985)', 'rotate(1.49deg) scale(1.018)', 'rotate(-0.37deg) scale(0.997)', 'rotate(0deg) scale(1)'],
    transition: {
      duration: 0.74,
...
const shackleVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(-17.47deg)', 'rotate(-15.53deg)', 'rotate(0deg)'],
    transition: {
      duration: 0.79,
      ease: [0.77, 0, 0.175, 1],
    },
