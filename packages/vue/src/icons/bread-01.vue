...
defineOptions({ inheritAttrs: false, name: 'Bread01Icon' })
...
// the loaf proofs — it rises and swells, then settles
// authored from scripts/authored
const loafVariants: Variants = {
