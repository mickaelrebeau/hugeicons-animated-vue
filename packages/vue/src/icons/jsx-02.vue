...
defineOptions({ inheritAttrs: false, name: 'Jsx02Icon' })
...
const nibVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg) translate(0px, 0px)', 'rotate(-8.42deg) translate(-0.42px, 0.63px)', 'rotate(4.21deg) translate(0.32px, -0.32px)', 'rotate(0deg) translate(0px, 0px)'],
    transition: {
      duration: 0.57,
      ease: [0.23, 1, 0.32, 1],
    },
