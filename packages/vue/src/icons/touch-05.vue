...
defineOptions({ inheritAttrs: false, name: 'Touch05Icon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['translateX(0px) scaleX(1) scaleY(1)', 'translateX(-0.86px) scaleX(0.9) scaleY(1.04)', 'translateX(2.14px) scaleX(1.1) scaleY(0.97)', 'translateX(0px) scaleX(1) scaleY(1)'],
    transition: {
      duration: 0.54,
      ease: [0.23, 1, 0.32, 1],
    },
