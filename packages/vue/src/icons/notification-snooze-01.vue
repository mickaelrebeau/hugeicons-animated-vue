...
defineOptions({ inheritAttrs: false, name: 'NotificationSnooze01Icon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(-13.55deg)', 'rotate(10.64deg)', 'rotate(-7.74deg)', 'rotate(4.84deg)', 'rotate(-1.94deg)', 'rotate(0deg)'],
    transition: {
      duration: 0.87,
      ease: 'easeInOut',
