...
defineOptions({ inheritAttrs: false, name: 'CallOutgoing04Icon' })
...
const arrowVariants: Variants = {
  ...
  animate: {
    transform: ['translateX(0px)', 'translateX(2.81px)', 'translateX(-0.28px)', 'translateX(0px)'],
    transition: {
      duration: 0.6,
      ease: [0.23, 1, 0.32, 1],
    },
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            <motion.path d="M21 7V3H17M15 9L20.5941 3.40586" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="arrowVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '18px 6px' }" />
