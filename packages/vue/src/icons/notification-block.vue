...
defineOptions({ inheritAttrs: false, name: 'NotificationBlockIcon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(-14.72deg)', 'rotate(11.57deg)', 'rotate(-8.41deg)', 'rotate(5.26deg)', 'rotate(-2.1deg)', 'rotate(0deg)'],
    transition: {
      duration: 0.92,
      ease: 'easeInOut',
