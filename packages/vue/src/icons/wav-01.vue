...
defineOptions({ inheritAttrs: false, name: 'Wav01Icon' })
...
// after arrow-down-02: the wav follows the down direction already encoded by its geometry
...
const arrowVariants: Variants = {
  ...
  animate: {
    transform: ['translateY(0px) scaleX(1)', 'translateY(2.58px) scaleX(0.94)', 'translateY(-0.3px) scaleX(1.02)', 'translateY(0.45px) scaleX(0.99)', 'translateY(0px) scaleX(1)'],
    transition: {
      duration: 0.49,
      ease: [0.23, 1, 0.32, 1],
    },
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            ...
            <motion.path d="M4 16V22L6.5 19L9 22V16M11.25 22L13 16H13.5L15.25 22M12.25 20H14.25M16 16L17.75 22H18.25L20 16" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="arrowVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '12px 12px' }" />
          </svg>
        </div>
</template>
