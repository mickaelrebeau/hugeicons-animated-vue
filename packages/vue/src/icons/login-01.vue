...
defineOptions({ inheritAttrs: false, name: 'Login01Icon' })
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          ...
          <motion.path d="M13 9C13 9 16 11.2095 16 12C16 12.7906 13 15 13 15M15.5 12H3" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="pathVariants" :custom="1" :animate="controls" initial="normal" />
          </svg>
        </div>
</template>
