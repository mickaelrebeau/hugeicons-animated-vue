...
defineOptions({ inheritAttrs: false, name: 'BookmarkAdd01Icon' })
...
// the plus stamps beside the still ribbon, fold holding
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            ...
            <path d="M3.5 7.00005H10" stroke="currentColor" stroke-linecap="round" stroke-width="1.5" />
