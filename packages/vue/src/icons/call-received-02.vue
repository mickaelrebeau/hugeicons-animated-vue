...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(-10.26deg)', 'rotate(8.21deg)', 'rotate(-5.13deg)', 'rotate(0deg)'],
    transition: {
      duration: 0.7,
      ease: 'easeInOut',
    },
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            <motion.path d="M20 11V8.5C20 6.84315 18.6569 5.5 17 5.5H14M15.5 3L13 5.5L15.5 8" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="iconVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '11.98px 3px' }" />
