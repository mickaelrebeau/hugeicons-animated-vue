...
defineOptions({ inheritAttrs: false, name: 'GoBackward30SecIcon' })
...
const arrowVariants: Variants = {
  ...
  animate: {
    transform: ['translateX(0px) scaleY(1)', 'translateX(2.52px) scaleY(0.94)', 'translateX(-0.29px) scaleY(1.02)', 'translateX(0.44px) scaleY(0.99)', 'translateX(0px) scaleY(1)'],
    transition: {
      duration: 0.48,
      ease: [0.23, 1, 0.32, 1],
    },
