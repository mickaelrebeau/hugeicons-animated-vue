...
defineOptions({ inheritAttrs: false, name: 'ColorPickerIcon' })
...
// after folder-01: the parts of the color picker move from their own mass and settle together
