...
defineOptions({ inheritAttrs: false, name: 'AiPhoneIcon' })
...
// the handset tips into the hand, the spark trailing the tilt
// authored from scripts/authored
const handsetVariants: Variants = {
  normal: { transform: 'rotate(0deg)' },
  animate: {
    transform: ['rotate(0deg)', 'rotate(-3.4deg)', 'rotate(0.9deg)', 'rotate(0deg)'],
...
const homeVariants: Variants = {
  ...
  animate: {
    ...
    opacity: [1, 0.6, 1],
    transition: { duration: 0.44, delay: 0.16, times: [0, 0.42, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
