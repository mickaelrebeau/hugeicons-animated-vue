...
defineOptions({ inheritAttrs: false, name: 'UserLove01Icon' })
...
const headVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg)', 'rotate(17.18deg)', 'rotate(-4.3deg)', 'rotate(0deg)'],
    transition: {
      duration: 0.62,
      ease: 'easeInOut',
      times: [0, 0.4, 0.7, 1],
...
const personVariants: Variants = {
  ...
  animate: {
    transform: ['translateY(0px) scale(1)', 'translateY(-1.48px) scale(1.03)', 'translateY(0.49px) scale(0.98)', 'translateY(0px) scale(1)'],
    transition: {
      duration: 0.55,
      ease: [0.23, 1, 0.32, 1],
    },
