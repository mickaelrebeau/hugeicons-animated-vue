...
defineOptions({ inheritAttrs: false, name: 'AiBrain01Icon' })
...
// the two hemispheres fire in turn, left then right, and lean away from the midline
// authored from scripts/authored
const leftLobeVariants: Variants = {
  normal: { transform: 'translateX(0px) scale(1)' },
  animate: {
    transform: ['translateX(0px) scale(1)', 'translateX(-0.55px) scale(1.045)', 'translateX(0px) scale(1)'],
    transition: { duration: 0.72, times: [0, 0.34, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
...
const rightLobeVariants: Variants = {
  ...
  animate: {
    transform: ['translateX(0px) scale(1)', 'translateX(0.55px) scale(1.045)', 'translateX(0px) scale(1)'],
    transition: { duration: 0.72, delay: 0.18, times: [0, 0.34, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
