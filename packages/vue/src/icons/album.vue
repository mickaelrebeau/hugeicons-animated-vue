...
// the disc turns a quarter in its sleeve and the cutout catches the light
...
const cutoutVariants: Variants = {
  normal: { transform: 'rotate(0deg)' },
  animate: {
    transform: ['rotate(0deg)', 'rotate(18deg)', 'rotate(-4deg)', 'rotate(0deg)'],
    transition: { duration: 0.78, times: [0, 0.48, 0.78, 1], ease: [0.23, 1, 0.32, 1] },
  },
};
