...
// both stitch rows rewrite around the still ball
// authored from scripts/authored
const stitchLVariants: Variants = {
...
const stitchRVariants: Variants = {
  normal: { pathLength: 1, pathOffset: 0, visibility: 'visible' },
  animate: {
    pathLength: [1, 0.14, 1],
    pathOffset: [0, 0.5, 0],
