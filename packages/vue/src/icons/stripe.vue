...
defineOptions({ inheritAttrs: false, name: 'StripeIcon' })
...
// after home-01: the silhouette of the stripe loads onto its base and settles with weight
