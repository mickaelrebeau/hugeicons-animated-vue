...
defineOptions({ inheritAttrs: false, name: 'HierarchySquare07Icon' })
...
const tileVariants: Variants = {
  ...
  animate: (i: number) => ({
    transform: ['translateY(1.42px) scale(0.74)', 'translateY(-0.4px) scale(1.1)', 'translateY(0px) scale(1)'],
