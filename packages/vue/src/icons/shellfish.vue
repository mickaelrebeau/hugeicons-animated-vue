...
defineOptions({ inheritAttrs: false, name: 'ShellfishIcon' })
...
// after folder-01: the parts of the shellfish move from their own mass and settle together
