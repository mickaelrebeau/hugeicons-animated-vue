...
defineOptions({ inheritAttrs: false, name: 'Home06Icon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['translateY(0px)', 'translateY(-2.09px)', 'translateY(0px)'],
    transition: {
      duration: 0.51,
      ease: 'easeInOut',
      times: [0, 0.35, 1],
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            ...
            <motion.path d="M18 15C18 13.8954 17.1046 13 16 13C14.8954 13 14 13.8954 14 15C14 16.1046 14.8954 17 16 17C17.1046 17 18 16.1046 18 15Z" stroke="currentColor" stroke-linejoin="round" stroke-width="1.5" :variants="markVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '14px 15px' }" />
          </svg>
        </div>
</template>
