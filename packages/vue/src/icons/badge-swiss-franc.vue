...
// the F stem writes, then the two crossbars grow from it
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            ...
            <motion.path d="M15 8H12C11.4477 8 11 8.44772 11 9V17" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="stemVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '13px 12.5px' }" />
            <motion.path d="M11 11H14" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="barAVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '12.5px 11px' }" />
            <motion.path d="M9 15H13" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="barBVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '11px 15px' }" />
          </svg>
        </div>
</template>
