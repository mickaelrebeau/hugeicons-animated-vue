...
defineOptions({ inheritAttrs: false, name: 'BinaryCodeIcon' })
...
// the four 1s rewrite in reading order, the 0 blocks holding
// authored from scripts/authored
const oneTLVariants: Variants = {
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            ...
            <motion.path d="M9 5L10.5 4V10" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="oneTLVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '9.8px 7px' }" />
            <motion.path d="M2 15L3.5 14V20" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="oneBLVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '2.8px 17px' }" />
            <motion.path d="M20.5 5L22 4V10" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="oneTRVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '21.3px 7px' }" />
            <motion.path d="M20.5 15L22 14V20" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="oneBRVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '21.3px 17px' }" />
          </svg>
        </div>
</template>
