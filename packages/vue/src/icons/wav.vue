...
defineOptions({ inheritAttrs: false, name: 'WavIcon' })
...
const arrowVariants: Variants = {
  ...
  animate: {
    transform: ['translateY(0px) scaleX(1)', 'translateY(2.47px) scaleX(0.94)', 'translateY(-0.29px) scaleX(1.02)', 'translateY(0.43px) scaleX(0.99)', 'translateY(0px) scaleX(1)'],
    transition: {
      duration: 0.47,
      ease: [0.23, 1, 0.32, 1],
    },
