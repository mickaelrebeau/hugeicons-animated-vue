...
// after airplane-take-off-01: the plane rolls, rotates, and climbs out of the frame; a second one slots onto the runway
...
const planeVariants: Variants = {
  ...
  animate: {
    transform: ['translate(0px, 0px) rotate(0deg)', 'translate(2.13px, -0.64px) rotate(-1.06deg)', 'translate(8.51px, -5.32px) rotate(-6.38deg)', 'translate(17.02px, -12.77px) rotate(-11.7deg)', 'translate(27.66px, -19.15px) rotate(-13.83deg)', 'translate(-23.41px, 12.77px) rotate(12.77deg)', 'translate(-8.51px, 4.26px) rotate(4.26deg)', 'translate(0px, 0px) rotate(0deg)'],
