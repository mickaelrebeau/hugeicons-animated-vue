...
defineOptions({ inheritAttrs: false, name: 'CallMinus02Icon' })
...
// the minus slices in and the handset shrinks back
...
const minusVariants: Variants = {
  ...
  animate: {
    transform: [
      ...
      'translate(-3.15px, 0px) scaleX(0.1)',
      'translate(0.56px, 0px) scaleX(1.16)',
      'translate(0.00px, 0px) scaleX(1)',
    ],
    transition: {
      duration: 0.5,
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            <motion.path d="M21 6H14" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="minusVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '17.5px 6px' }" />
