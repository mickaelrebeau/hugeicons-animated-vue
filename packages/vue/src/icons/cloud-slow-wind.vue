...
defineOptions({ inheritAttrs: false, name: 'CloudSlowWindIcon' })
...
const iconVariants: Variants = {
  ...
  animate: {
    transform: ['rotate(0deg) translateX(0px)', 'rotate(-11.94deg) translateX(1.59px)', 'rotate(4.98deg) translateX(-0.4px)', 'rotate(-1.99deg) translateX(0.2px)', 'rotate(0deg) translateX(0px)'],
    transition: {
      duration: 0.69,
      ease: [0.23, 1, 0.32, 1],
    },
