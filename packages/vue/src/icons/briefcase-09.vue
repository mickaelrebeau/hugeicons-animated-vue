...
defineOptions({ inheritAttrs: false, name: 'Briefcase09Icon' })
...
// the two straps cinch toward the center and release
...
<template>
  <div class="hia-icon" @mouseenter="onMouseEnter" @mouseleave="onMouseLeave" v-bind="$attrs">
          <svg xmlns="http://www.w3.org/2000/svg" :width="size" :height="size" viewBox="0 0 24 24" fill="none" overflow="visible">
            ...
            <motion.path d="M6.99934 6.49988V20.9999M16.9993 6.49988V20.9999" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" :variants="strapsVariants" :animate="controls" initial="normal" :style="{ transformOrigin: '12px 13.75px' }" />
          </svg>
        </div>
</template>
