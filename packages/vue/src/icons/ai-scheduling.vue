...
const dotVariants: Variants = {
  ...
  animate: (i: number) => ({
    transform: ['translateY(0px) scale(1)', 'translateY(-1.49px) scale(1.2)', 'translateY(0.35px) scale(0.95)', 'translateY(0px) scale(1)'],
